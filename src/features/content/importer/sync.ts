...
import {
  archiveRemovedCards,
  archiveRemovedLessons,
  archiveRemovedMedia,
  archiveRemovedScopedCards,
  collectScopedExistingEntryIds,
  pruneOrphanedCrossMediaGroups,
  pruneRemovedGrammarPatterns,
  pruneRemovedSegments,
  pruneRemovedTerms
} from "./sync-removal.ts";
import type {
  ExistingMediaState,
  ImportSyncSummary,
  MediaImportPlan
...
const cardUpsertSet = {
  ...
  exampleAudioSrc: excluded("example_audio_src"),
  exampleAudioSource: excluded("example_audio_source"),
  exampleAudioSpeaker: excluded("example_audio_speaker"),
  exampleAudioLicense: excluded("example_audio_license"),
  exampleAudioAttribution: excluded("example_audio_attribution"),
  exampleAudioPageUrl: excluded("example_audio_page_url"),
  notesIt: excluded("notes_it"),
  status: excluded("status"),
  orderIndex: excluded("order_index"),
  updatedAt: excluded("updated_at")
