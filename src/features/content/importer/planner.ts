...
function buildTermPlan(input: {
  ...
  return {
    ...
    row: {
      ...
      audioSrc: input.term.audio?.audioSrc ?? null,
      audioSource: input.term.audio?.audioSource ?? null,
      audioSpeaker: input.term.audio?.audioSpeaker ?? null,
      ...
      pitchAccentSource: input.term.pitchAccentSource ?? null,
      pitchAccentPageUrl: input.term.pitchAccentPageUrl ?? null,
...
function buildGrammarPlan(input: {
  ...
  return {
    ...
    row: {
      ...
      audioSrc: input.grammarPattern.audio?.audioSrc ?? null,
      audioSource: input.grammarPattern.audio?.audioSource ?? null,
      audioSpeaker: input.grammarPattern.audio?.audioSpeaker ?? null,
    ...
    .map((card, index) => {
      ...
      return {
        ...
        row: {
          ...
          exampleAudioSrc: card.exampleAudio?.audioSrc ?? null,
          exampleAudioSource: card.exampleAudio?.audioSource ?? null,
          exampleAudioSpeaker: card.exampleAudio?.audioSpeaker ?? null,
          exampleAudioLicense: card.exampleAudio?.audioLicense ?? null,
          exampleAudioAttribution: card.exampleAudio?.audioAttribution ?? null,
          exampleAudioPageUrl: card.exampleAudio?.audioPageUrl ?? null,
