...
import { applyKanjiClashSessionAction } from "./session-action.ts";
import { verifyKanjiClashQueueToken } from "./queue-token.ts";

export type SubmitKanjiClashAnswerInput = KanjiClashAnswerSubmissionPayload & {
  database?: DatabaseClient;
  responseMs?: number | null;
};

export async function submitKanjiClashAnswer(
  input: SubmitKanjiClashAnswerInput
