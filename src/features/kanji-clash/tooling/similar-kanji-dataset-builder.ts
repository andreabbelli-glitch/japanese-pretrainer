...
export function buildSimilarKanjiDataset(
  ...
  for (const [index, [leftKanji, rightKanji]] of (
    ...
    validateManualOverridePair("manualIncludes", index, leftKanji, rightKanji);
    const entry = getOrCreateSimilarKanjiDatasetEntry(
      entries,
      leftKanji,
      rightKanji
  ...
  for (const [index, [leftKanji, rightKanji]] of (
    ...
    validateManualOverridePair("manualExcludes", index, leftKanji, rightKanji);
    const entry = getOrCreateSimilarKanjiDatasetEntry(
      entries,
      leftKanji,
      rightKanji
