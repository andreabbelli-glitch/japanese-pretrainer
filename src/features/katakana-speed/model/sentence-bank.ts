...
export const KATAKANA_SPEED_SENTENCE_ROWS = [
  ...
  sentence("P28", "レヴューの舞台を見に、劇場へ行きました。", ["ヴュ"]),
  sentence("P29", "ティーとチーを見間違えないようにしてください。", ["ティ"]),
  sentence("P30", "ディーとジーを見間違えると、読むときに戸惑います。", [
    "ディ"
  ]),
  sentence("P31", "ファイルとハイルを見比べて、最初の文字を確かめます。", [
    "ファ"
  ]),
  sentence("P32", "フィルムとヒルムを並べて、反応時間を測ります。", ["フィ"]),
  sentence("P33", "ウェブとエブを並べると、小さいェに気づきやすくなります。", [
    "ウェ"
  ]),
  ...
  sentence("P45", "テューバは楽器、チューブは管を指す言葉です。", ["テュ"]),
