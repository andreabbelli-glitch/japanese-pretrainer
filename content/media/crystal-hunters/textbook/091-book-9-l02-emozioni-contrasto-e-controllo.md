---
id: lesson-crystal-hunters-book-9-l02-emozioni-contrasto-e-controllo
media_id: media-crystal-hunters
slug: book-9-l02-emozioni-contrasto-e-controllo
title: "Emozioni, contrasto e controllo"
order: 910
segment_ref: book-9
difficulty: n5
status: active
...
# Emozioni, contrasto e controllo
...
Il punto pratico e partire da [{{起|お}}き{{上|あ}}がる](term:term-ch-b9-kigaru-23) e dagli altri blocchi sotto: ogni card e pensata per preparare una battuta reale, non per studiare una lista astratta.

## Termini chiave

- [{{起|お}}き{{上|あ}}がる](term:term-ch-b9-kigaru-23) - rialzarsi.
- [{{観念|かんねん}}する](term:term-ch-b9-suru-24) - rassegnarsi; arrendersi mentalmente.
- [{{思|おも}}い{{知|し}}る](term:term-ch-b9-iru-25) - capire fino in fondo.
- [{{差|さ}}し{{支|つか}}えなければ](term:term-ch-b9-shienakereba-26) - se non e un problema; se posso chiedere.
- [{{欲|ほ}}しがる](term:term-ch-b9-shigaru-27) - mostrare di volere.
- [{{娯楽|ごらく}}](term:term-ch-b9-entry-28) - divertimento; intrattenimento.
- [{{刺激的|しげきてき}}](term:term-ch-b9-entry-29) - stimolante; eccitante.
- [{{負|ふ}}の{{感情|かんじょう}}](term:term-ch-b9-no-30) - emozioni negative.
- [{{苛|さいな}}む](term:term-ch-b9-mu-31) - tormentare.
- [{{屈強|くっきょう}}](term:term-ch-b9-entry-32) - robusto; vigoroso.
