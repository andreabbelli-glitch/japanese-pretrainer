---
id: lesson-crystal-hunters-book-10-l06-subtesto-oggetti-e-verbi-composti
media_id: media-crystal-hunters
slug: book-10-l06-subtesto-oggetti-e-verbi-composti
title: "Subtesto, oggetti e verbi composti"
order: 1050
segment_ref: book-10
difficulty: n5
status: active
...
prerequisites: []
summary: >-
  Chiudere il Book 10 leggendo oggetti fisici, margine mentale, punizioni,
  citazioni, frasi attributive e verbi composti.
---
...
- [{{物|もの}}](term:term-ch-b10-mono) — cosa fisica, oggetto
- [{{余裕|よゆう}}](term:term-ch-b10-yoyuu) — margine, spazio mentale o temporale
- [{{辞|じ}}す](term:term-ch-b10-jisu) — rifiutare, tirarsi indietro; in negativo, non esitare
- [{{仕置|しお}}き](term:term-ch-b10-shioki) — punizione
- [{{取|と}}り{{出|だ}}す](term:term-ch-b10-toridasu) — tirare fuori, estrarre
- [{{味|あじ}}わう](term:term-ch-b10-ajiwau) — assaporare, vivere pienamente
- [{{終|お}}わる](term:term-ch-b10-owaru) — finire, terminare
- [{{休|やす}}む](term:term-ch-b10-yasumu) — riposare, prendersi una pausa
...
- [こと e もの](grammar:grammar-ch-b10-koto-vs-mono) — cosa astratta vs cosa fisica

## Etichette da riconoscere

- `{{四|し}}・{{五|ご}}・{{六|ろく}}` — numeri usati nel conteggio
- `{{今日|きょう}}` — oggi
- `そして` — e poi, quindi
- `さあ` — forza, su, vediamo
- `やあ` — ehi, ciao
...
jp: >-
  {{何|なん}}だと？
translation_it: >-
  Che cosa hai detto!? / Come sarebbe!?
:::
...
:::example_sentence
jp: >-
  {{女王|じょおう}}は{{私達|わたしたち}}はバカだと{{言|い}}った。
translation_it: >-
...
*   `{{女王|じょおう}}は` -> **tema della frase esterna**.
*   `{{私達|わたしたち}}はバカだ` -> **contenuto citato**.
*   `と{{言|い}}った` -> **cornice di citazione**: "ha detto che...".
...
:::example_sentence
jp: >-
  {{逃|に}}げている{{男|おとこ}}を{{見|み}}た。
translation_it: >-
  Ho visto l'uomo che sta scappando.
:::
...
jp: >-
  {{考|かんが}}える{{事|こと}}がある。
translation_it: >-
  Ho una cosa a cui pensare.
:::

#### ⚖️ Contrasto operativo

Prima del nome non usare la forma cortese: `{{考|かんが}}えます{{事|こと}}` suona
sbagliato. Il manga usa forme piane come `{{考|かんが}}える{{事|こと}}`.

## 8. Verbi composti: giu', fuori, inizio

[{{取|と}}り{{出|だ}}す](term:term-ch-b10-toridasu) segue il modello
verbo-stem + verbo: {{取|と}}り + {{出|だ}}す. Il secondo verbo aggiunge direzione
o risultato.

:::example_sentence
jp: >-
  {{頭|あたま}}から{{石|いし}}を{{取|と}}り{{出|だ}}す。
translation_it: >-
  Tiro fuori la pietra dalla testa.
:::
...
jp: >-
  よかった、{{食|た}}べられて。
translation_it: >-
  Meno male che siamo riusciti a mangiare.
:::

La stessa cosa funziona con valutazioni come `いいな`: prima arriva "che bello /
ti invidio", poi la parte in `て` chiarisce per cosa.

:::example_sentence
jp: >-
  いいな、たくさんのお{{金|かね}}をもらって。
translation_it: >-
  Che bello, hai ricevuto tanti soldi.
:::
...
:::example_sentence
jp: >-
  この{{物|もの}}を{{取|と}}り{{出|だ}}す{{余裕|よゆう}}がない。
translation_it: >-
  Non ho margine per tirare fuori questo oggetto.
:::
