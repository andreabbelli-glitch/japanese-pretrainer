...
- [カードスロット](term:term-card-slot): è la zona in cui inserisci le carte da
  ...
  [ユニット](term:term-unit).
- [カードリーダー](term:term-card-reader): è il punto in cui appoggi la tessera
...
1. Tocchi l'[アミューズメントICカード](term:term-amusement-ic-card) al
   ...
   [{{呼|よ}}び{{出|だ}}す](term:term-call-up) i dati già salvati o crearne di
   nuovi.
