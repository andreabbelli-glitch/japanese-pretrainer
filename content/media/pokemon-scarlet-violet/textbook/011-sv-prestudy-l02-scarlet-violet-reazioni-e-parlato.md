---
id: lesson-pokemon-scarlet-violet-sv-prestudy-011-sv-prestudy-l02-scarlet-violet-reazioni-e-parlato
media_id: media-pokemon-scarlet-violet
slug: 011-sv-prestudy-l02-scarlet-violet-reazioni-e-parlato
title: "Reazioni e parlato iniziale: scuola, richieste e tono colloquiale"
order: 41
...
prerequisites: []
summary: >-
  Leggere dialoghi iniziali e messaggi di sistema: urgenza di もう, rapporto con
  よろしく, richieste negative e parlato contratto.
---
...
- [もう](term:term-v013-mou) — già / ormai / su, adesso
- [ライド](term:term-v014-raido) — ride / cavalcata
- [{{自分|じぶん}}](term:term-v015-jibun) — sé stesso / personalmente
- [すごい](term:term-v016-sugoi) — incredibile / notevole
- [{{学校|がっこう}}](term:term-v019-gakkou) — scuola
...
- [{{持|も}}ちきれない / {{持|も}}ちきれません](term:term-e003-mochikirenai-mochikiremasen) — non puoi portarne di più / inventario pieno
- [がんばって](term:term-e004-ganbatte) — forza / buona fortuna
- [よろしく](term:term-e005-yoroshiku) — piacere / conto su di te
...
*   `ジムバトル` ➔ **tema ellittico**: la scena fornisce il contesto, quindi non serve un verbo completo come "fare una lotta in palestra".
*   `がんばって` ➔ **forma in `-te` usata come incoraggiamento**: letteralmente "impegnati / tieni duro", ma pragmaticamente è un saluto di sostegno prima della prova.
...
## 2. Messaggi operativi: muoversi, portare e non fare
...
*   `ライドで` ➔ **mezzo dell'azione**: `で` dice "tramite / usando la cavalcata", non "dentro il ride".
*   `こっちへ` ➔ **direzione**: `へ` punta verso "questa parte", utile nei tutorial di movimento.
*   `{{行|い}}きます` ➔ **azione cortese**: il verbo di movimento resta semplice, mentre `ライドで` spiega come avviene lo spostamento.
...
:::example_sentence
jp: >-
  これ{{以上|いじょう}}は {{持|も}}ち{{切|き}}れません。
translation_it: >-
  Non puoi portarne di più.
:::
...
*   `アカデミーで` ➔ **luogo dell'incontro**: `で` marca dove avviene l'azione.
...
*   `すごい！` ➔ **reazione autonoma**: non specifica da sola che cosa è forte; il contesto fornisce l'oggetto dell'ammirazione.
...
## 5. `{{自分|じぶん}}` e `サンドウィッチ`: personale, quotidiano, concreto
...
Le stesse forme si riconoscono meglio quando tornano insieme: una battuta spinge avanti la scena, una UI blocca l'inventario, una parola istituzionale colloca il personaggio, una forma colloquiale rende naturale il parlato.

:::example_sentence
jp: >-
  もう {{行|い}}こう、 アカデミーで {{新|あたら}}しい {{生徒|せいと}}が {{待|ま}}ってる。
translation_it: >-
  Andiamo ormai: all'Accademia un nuovo studente sta aspettando.
:::

:::example_sentence
jp: >-
  これ{{以上|いじょう}}は {{持|も}}ち{{切|き}}れません。 サンドウィッチを {{選|えら}}ばないで。
translation_it: >-
  Non puoi portarne di più. Non selezionare il sandwich.
:::
