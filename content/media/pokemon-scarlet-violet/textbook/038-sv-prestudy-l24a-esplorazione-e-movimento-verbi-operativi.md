...
- [{{主人公|しゅじんこう}}](term:term-v442-shujinkou) — protagonista
- [オンライン](term:term-v436-onrain) — online
- [オフライン](term:term-v440-ofurain) — offline
...
- [{{都市|とし}}](term:term-v447-toshi) — città
- [{{崖|がけ}}](term:term-v444-gake) — dirupo / parete rocciosa
- [{{降|お}}りる](term:term-v434-ori-ru) — scendere
- [{{方角|ほうがく}}](term:term-v448-hougaku) — direzione cardinale
- [{{珍|めずら}}しい](term:term-v453-mezurashii) — raro / insolito
- [{{遅|おそ}}い](term:term-v438-osoi) — lento / tardi
- [{{嬉|うれ}}しい](term:term-v435-ureshii) — felice / contento
- [{{復活|ふっかつ}}](term:term-v437-fukkatsu) — ritorno / ripresa

## Espressioni ricorrenti

- [きみ{{次第|しだい}}](term:term-e081-kimi-shidai) — dipende da te
- [ここまで{{来|き}}たら](term:term-e082-kokomade-kita-ra) — arrivati fin qui / se siamo arrivati fin qui
- [{{全力|ぜんりょく}}でいこう](term:term-e083-zenryoku-deikou) — andiamo al massimo
- [まだ{{終|お}}わりじゃない](term:term-e084-mada-owari-janai) — non è ancora finita

## Pattern grammaticali chiave

- [～と](grammar:grammar-g085-quando-se-risultato-naturale) — quando fai X, succede naturalmente Y
- [frase relativa ({{連体修飾|れんたいしゅうしょく}})](grammar:grammar-g086-frase-che-modifica-un-nome) — frase che modifica un nome
- [{{受|う}}け{{身|み}}](grammar:grammar-g087-forma-passiva) — passiva: il focus va su chi riceve l'azione
- [しか～ない](grammar:grammar-g088-solo-e-nient-altro) — solo quello, nient'altro

## Etichette da riconoscere

- [{{北|きた}}](term:term-v449-kita) — nord
- [{{南|みなみ}}](term:term-v450-minami) — sud
- [{{西|にし}}](term:term-v451-nishi) — ovest
- [{{東|ひがし}}](term:term-v452-higashi) — est
...
:::example_sentence
jp: >-
  これしか ない。まだ {{終|お}}わりじゃない。
translation_it: >-
  C'è solo questo. Non è ancora finita.
:::
...
:::example_sentence
jp: >-
  オンラインで {{遊|あそ}}ぶか オフラインで {{進|すす}}むかは きみ{{次第|しだい}}だよ。
translation_it: >-
  Dipende da te se giocare online o proseguire offline.
:::

:::example_sentence
jp: >-
  このポケモンに {{新|あたら}}しい わざを {{覚|おぼ}}えさせて、しっかり {{鍛|きた}}えよう。
translation_it: >-
  Facciamo imparare una nuova mossa a questo Pokémon e alleniamolo bene.
:::
...
:::example_sentence
jp: >-
  {{珍|めずら}}しい ポケモンを {{見|み}}つけた。これしか ない、{{全力|ぜんりょく}}で いこう。
translation_it: >-
