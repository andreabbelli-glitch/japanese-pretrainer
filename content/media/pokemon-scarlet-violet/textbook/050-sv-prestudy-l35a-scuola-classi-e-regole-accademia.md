...
- [グラウンド](term:term-v735-guraundo) — campo sportivo dell'accademia, usato
  per spiegazioni e dimostrazioni pratiche
...
:::example_sentence
jp: >-
  グラウンドで {{説明|せつめい}}を いたしますので、{{階段|かいだん}}を
  {{下|お}}りて {{集合|しゅうごう}}してください。
translation_it: >-
  Faremo la spiegazione nel campo sportivo, quindi scendete le scale e
  radunatevi.
:::
