...
prerequisites: []
summary: >-
  Leggere spostamenti, lotte e richieste quando il gioco indica destinazioni,
...
- [{{倒|たお}}す](term:term-v115-taosu) — sconfiggere / far cadere
- [{{次|つぎ}}](term:term-v116-tsugi) — prossimo / seguente
- [{{勝|か}}つ](term:term-v119-katsu) — vincere
- [{{弱|よわ}}い](term:term-v120-yowai) — debole
- [{{買|か}}う](term:term-v121-kau) — comprare
- [{{誰|だれ}}](term:term-v122-dare) — chi
- [いくら](term:term-v123-ikura) — quanto / quanto costa
- [{{海|うみ}}](term:term-v124-umi) — mare

## Espressioni ricorrenti

- [〜してみたら？](term:term-e021-shitemitara) — perché non provi a…?
- [〜してくれる？](term:term-e022-shitekureru) — me lo fai?

## Pattern grammaticali chiave

- [と](grammar:grammar-g028-con-e-citazione) — con / e / citazione
- [に](grammar:grammar-g029-destinazione-tempo-bersaglio-esistenza) — destinazione, tempo, bersaglio, esistenza
- [の](grammar:grammar-g030-possesso-collegamento-tra-nomi) — possesso / collegamento tra nomi

## Etichette da riconoscere

- [そらとぶタクシー](term:term-v113-soratobutakushii) — trasporto rapido tramite Taxi Volante
- [おまかせバトル](term:term-v118-omakasebatoru) — lotta automatica affidata al Pokémon
...
:::example_sentence
jp: >-
  そらとぶタクシーで {{次|つぎ}}の {{町|まち}}に {{行|い}}ってみたら？
translation_it: >-
  Perché non provi ad andare alla prossima città con il Taxi Volante?
:::
...
:::example_sentence
jp: >-
  {{弱|よわ}}い ポケモンを {{倒|たお}}して、 バトルに {{勝|か}}つ。
translation_it: >-
  Sconfiggi un Pokémon debole e vinci la lotta.
:::
...
:::example_sentence
jp: >-
  この {{道具|どうぐ}}を {{買|か}}ってくれる？
translation_it: >-
  Mi compri questo strumento?
:::
...
:::example_sentence
jp: >-
  {{友達|ともだち}}と {{海|うみ}}の {{近|ちか}}くに {{行|い}}く。
translation_it: >-
  Vado con un amico vicino al mare.
:::
...
Le stesse forme diventano più rapide da leggere quando mappa, battaglia e dialogo si intrecciano:

:::example_sentence
jp: >-
  {{次|つぎ}}の ジムに {{行|い}}ってみたら？
translation_it: >-
  Perché non provi ad andare alla prossima palestra?
:::

:::example_sentence
jp: >-
  おまかせバトルで {{弱|よわ}}い ポケモンを {{倒|たお}}す。
translation_it: >-
  Sconfiggi un Pokémon debole con la lotta automatica.
:::

:::example_sentence
jp: >-
  {{誰|だれ}}が この {{道具|どうぐ}}を {{買|か}}う？
translation_it: >-
  Chi compra questo strumento?
:::

:::example_sentence
jp: >-
  {{海|うみ}}の {{近|ちか}}くで {{友達|ともだち}}と {{勝|か}}った。
translation_it: >-
  Ho vinto con un amico vicino al mare.
:::
...
Quando il gioco parla di movimento, cerca subito il mezzo, la destinazione e il prossimo punto. Quando parla di lotta, separa l'azione di [{{倒|たお}}す](term:term-v115-taosu) dall'esito di [{{勝|か}}つ](term:term-v119-katsu). Nei dialoghi, [〜してみたら？](term:term-e021-shitemitara) apre una proposta, mentre [〜してくれる？](term:term-e022-shitekureru) trasforma l'azione in un favore chiesto a qualcuno. Le particelle piccole fanno da bussola: [に](grammar:grammar-g029-destinazione-tempo-bersaglio-esistenza) punta, [と](grammar:grammar-g028-con-e-citazione) accompagna o cita, [の](grammar:grammar-g030-possesso-collegamento-tra-nomi) collega nomi.
