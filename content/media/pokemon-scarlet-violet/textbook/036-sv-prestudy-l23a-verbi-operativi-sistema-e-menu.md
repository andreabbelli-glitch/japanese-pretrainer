...
- [{{進|すす}}む](term:term-v394-susumu) — procedere / avanzare
- [{{飛|と}}ぶ](term:term-v396-tobu) — volare / spostarsi rapidamente
- [{{帰|かえ}}る](term:term-v397-kaeru) — tornare
- [{{開|ひら}}く](term:term-v407-hiraku) — aprire
- [{{調|しら}}べる](term:term-v403-shirabe-ru) — controllare / investigare
- [{{出会|であ}}う](term:term-v410-deau) — imbattersi in / incontrare
- [まっすぐ](term:term-v409-massugu) — dritto
- [{{低|ひく}}い](term:term-v408-hikui) — basso
- [{{整理|せいり}}](term:term-v393-seiri) — riordino / organizzazione
- [{{先頭|せんとう}}](term:term-v411-sentou) — posizione di testa / primo
- [どうやら](term:term-v404-douyara) — a quanto pare

## Espressioni ricorrenti

- [{{見|み}}てみよう](term:term-e075-mitemiyou) — proviamo a vedere / controlliamo
- [あとは{{任|まか}}せて](term:term-e076-atoha-makase-te) — al resto penso io
...
- [～たがる](grammar:grammar-g080-sembrare-voler-fare-terza-persona) — sembrare voler fare, visto dall'esterno
...
- [{{通信|つうしん}}](term:term-v267-tsuushin) — comunicazione o connessione che
...
[どうやら](term:term-v404-douyara) serve quando il gioco presenta una conclusione
ricavata da indizi: "a quanto pare". Se compare con [{{出会|であ}}う](term:term-v410-deau)
o con una forma come `ようです`, non sta dichiarando un fatto osservato in modo
brusco; sta leggendo la situazione dall'esterno.
...
Le frasi operative diventano più facili quando separi oggetto, destinazione e persona coinvolta:
...
:::example_sentence
jp: >-
  ボックスの ポケモンを {{整理|せいり}}して、{{先頭|せんとう}}を {{決|き}}めます。
translation_it: >-
  Riordino i Pokémon della box e decido chi mettere in prima posizione.
:::
...
:::example_sentence
jp: >-
  どうやら めずらしい ポケモンに {{出会|であ}}ったようです。
translation_it: >-
  A quanto pare ti sei imbattuto in un Pokémon raro.
:::

## Nota finale

Quando un comando è corto, parti dalla particella: を di solito marca ciò che apri, riordini o controlli; に e へ orientano il movimento verso un luogo o un incontro; と porta dentro la persona con cui scambi, combatti o collabori. Da lì i verbi [{{進|すす}}む](term:term-v394-susumu), [{{開|ひら}}く](term:term-v407-hiraku), [{{調|しら}}べる](term:term-v403-shirabe-ru) e [{{出会|であ}}う](term:term-v410-deau) smettono di essere gloss isolate e diventano istruzioni leggibili nel flusso del gioco.
