...
:::example_sentence
jp: >-
  チャンピオンランクを {{目指|めざ}}すなら ジムバッジを
  {{集|あつ}}めるだけじゃなく {{強|つよ}}い トレーナーとして
  {{認|みと}}められる {{必要|ひつよう}}が ある。
translation_it: >-
  Se punti al Champion Rank, non basta raccogliere Medaglie Palestra: devi
  essere riconosciuto come Allenatore forte.
:::

:::example_sentence
jp: >-
  {{行|い}}きたい {{場所|ばしょ}}を {{目的|もくてき}}{{地|ち}}に
  {{登録|とうろく}}しておくと {{次|つぎ}}の {{道|みち}}が わかりやすい。
translation_it: >-
  Se registri come destinazione il luogo in cui vuoi andare, capisci meglio la
  prossima strada.
:::

## Nota finale

Questa parte del prologo funziona perché ogni parola sposta un confine.
[{{課外|かがい}}{{授業|じゅぎょう}}](term:term-kagai-jugyou) porta la scuola fuori
dal campus, [{{宝|たから}}{{探|さが}}し](term:term-takara-sagashi) impedisce di
ridurre il viaggio a un solo tesoro, [チャンピオンランク](term:term-champion-rank)
