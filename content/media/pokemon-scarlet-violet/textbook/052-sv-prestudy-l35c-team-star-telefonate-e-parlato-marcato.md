...
translation_it: >-
  Vorrei che continuassi a prenderti bene cura di Koraidon.
:::
...
:::example_sentence
jp: >-
  {{監視|かんし}}カメラに {{姿|すがた}}が {{映|うつ}}っていたなら、
  {{場所|ばしょ}}は もう {{知|し}}られているんじゃない？
translation_it: >-
  Se la tua immagine è comparsa sulle telecamere di sorveglianza, forse il luogo è già noto.
:::

:::example_sentence
jp: >-
  オマエの {{力|ちから}}を {{借|か}}りる つもりはない。 ただ
  {{管理|かんり}}できない {{状況|じょうきょう}}なんだ。
translation_it: >-
  Non ho intenzione di chiederti aiuto. È solo che non riesco a gestire la situazione.
:::
