...
- [{{模様|もよう}}](term:term-v692-moyou) — motivo / pattern visivo
- [{{可能性|かのうせい}}](term:term-v693-kanousei) — possibilità
- [スマホカバー](term:term-v697-sumahokabaa) — cover dello smartphone
- [サークルミッション](term:term-v699-saakurumisshon) — missione di gruppo
- [{{配達|はいたつ}}](term:term-v700-haitatsu) — consegna
- [{{通常|つうじょう}}](term:term-v701-tsuujou) — normale / standard
- [{{変身|へんしん}}](term:term-v703-henshin) — trasformazione
- [{{拠点|きょてん}}](term:term-v704-kyoten) — base / punto d'appoggio
- [{{雰囲気|ふんいき}}](term:term-v708-funiki) — atmosfera / mood
...
## 1. La mappa prima di tutto: nomi che fissano una posizione
...
Alcune parole non indicano un luogo o un'azione immediata, ma il grado di certezza o lo stato mostrato. [{{可能性|かのうせい}}](term:term-v693-kanousei) apre una possibilità, [{{通常|つうじょう}}](term:term-v701-tsuujou) riporta alla forma standard e [{{変身|へんしん}}](term:term-v703-henshin) segnala un cambio di aspetto o identità.

### A. `{{可能性|かのうせい}}がある`: possibile, non garantito

`{{可能性|かのうせい}}` unisce l'idea di "poter accadere" a una nominalizzazione astratta. Nel frame `{{可能性|かのうせい}}がある`, il gioco dice che un incontro, un risultato o un evento può succedere, ma non lo presenta come già avvenuto né come sicuro.

:::example_sentence
jp: >-
  この{{先|さき}}で {{珍|めずら}}しい ポケモンに {{会|あ}}える{{可能性|かのうせい}}が あります。
translation_it: >-
...
Le stesse etichette diventano più leggibili quando separi luogo, funzione e stato:
...
Quando una schermata di *Scarlet & Violet* sembra piena di nomi isolati, cerca prima la categoria: luogo sulla mappa, attività da completare, stato possibile o aspetto modificabile. [ナッペ{{山|やま}}](term:term-v685-nappeyama) e [オージャの{{湖|みずうみ}}](term:term-v698-oojanomizuumi) fissano lo spazio; [{{拠点|きょてん}}](term:term-v704-kyoten), [{{配達|はいたつ}}](term:term-v700-haitatsu) e [サークルミッション](term:term-v699-saakurumisshon) dicono che cosa fare; [{{通常|つうじょう}}](term:term-v701-tsuujou), [{{変身|へんしん}}](term:term-v703-henshin), [{{模様|もよう}}](term:term-v692-moyou) e [{{雰囲気|ふんいき}}](term:term-v708-funiki) spiegano quale stato o resa visiva stai guardando.
