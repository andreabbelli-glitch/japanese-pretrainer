...
- [{{広|ひろ}}げる](term:term-v454-hiroge-ru) — allargare / espandere
- [{{真剣|しんけん}}](term:term-v455-shinken) — serio
- [{{目印|めじるし}}](term:term-v456-mejirushi) — punto di riferimento
- [{{速|はや}}い](term:term-v457-hayai) — veloce
- [{{登|のぼ}}る](term:term-v458-noboru) — salire / arrampicarsi
- [はしご](term:term-v459-hashigo) — scala a pioli / ladder
- [{{協力|きょうりょく}}する](term:term-v460-kyouryoku-suru) — cooperare
- [{{立|た}}ち{{寄|よ}}る](term:term-v461-tachi-yoru) — fermarsi di passaggio
...
- [{{巡|めぐ}}る](term:term-v472-meguru) — girare / visitare più punti
- [{{並|なら}}べかえ](term:term-v473-narabekae) — riordinare una lista
- [{{入手|にゅうしゅ}}](term:term-v474-nyuushu) — ottenere / acquisire
- [{{引|ひ}}っ{{込|こ}}める](term:term-v475-hitsu-kome-ru) — ritirare un Pokémon dalla lotta
...
- [だけ](grammar:grammar-g089-solo) — solo
- [も](grammar:grammar-g090-anche) — anche
- [や / など](grammar:grammar-g091-tra-gli-altri-eccetera) — tra gli altri / eccetera
- [し](grammar:grammar-g092-e-inoltre-tra-l-altro) — e inoltre / tra l'altro
...
*   [{{手|て}}ごわい](term:term-v463-tegowai) qualifica un avversario, un
    ...
    il testo sta preparando una sfida ostica, dove conviene curare, cambiare
    squadra o scegliere meglio la mossa.
...
:::example_sentence
jp: >-
  ポケモンを {{回復|かいふく}}させてから、{{手|て}}ごわい {{相手|あいて}}に {{挑|いど}}みます。
translation_it: >-
  Curo il Pokémon e poi sfido un avversario ostico.
:::
...
:::example_sentence
jp: >-
  はしごを {{登|のぼ}}って、{{目印|めじるし}}の {{建物|たてもの}}に {{立|た}}ち{{寄|よ}}ります。
translation_it: >-
  Salgo la scala a pioli e mi fermo di passaggio all'edificio di riferimento.
:::
...
:::example_sentence
jp: >-
  しっそうけいたいで {{町|まち}}を {{巡|めぐ}}って、ゆうえいけいたいで {{水上|すいじょう}}を {{進|すす}}みます。
translation_it: >-
  Giro la città in forma corsa e avanzo sull'acqua in forma nuoto.
:::
...
:::example_sentence
jp: >-
  ポケモンのおとしものを {{入手|にゅうしゅ}}したら、どうぐを {{並|なら}}べかえます。
translation_it: >-
  Dopo aver ottenuto materiali lasciati dai Pokémon, riordino gli strumenti.
:::
...
[{{真剣|しんけん}}](term:term-v455-shinken) sposta il tono verso una cosa seria,
non leggera o scherzosa. Quando qualifica `{{話|はなし}}`, il dialogo segnala
che l'argomento va trattato con attenzione; con [し](grammar:grammar-g092-e-inoltre-tra-l-altro)
può diventare uno dei motivi per mantenere il segreto o procedere con cautela.
...
:::example_sentence
jp: >-
  {{真剣|しんけん}}な {{話|はなし}}だし、{{秘密|ひみつ}}だよ。
translation_it: >-
  È una cosa seria e, tra l'altro, è un segreto.
:::

:::example_sentence
jp: >-
  {{速|はや}}い しっそうけいたいで {{目印|めじるし}}まで {{行|い}}ってきます。
translation_it: >-
  Vado e torno fino al punto di riferimento usando la veloce forma corsa.
:::

:::example_sentence
jp: >-
  {{協力|きょうりょく}}してもらえる？ ポケモンのおとしものも {{入手|にゅうしゅ}}したい。
translation_it: >-
  Potresti collaborare con me? Vorrei ottenere anche materiali lasciati dai Pokémon.
:::

:::example_sentence
jp: >-
  バトルでは ポケモンを {{引|ひ}}っ{{込|こ}}めて、あとで ボックスに {{預|あず}}けます。
translation_it: >-
