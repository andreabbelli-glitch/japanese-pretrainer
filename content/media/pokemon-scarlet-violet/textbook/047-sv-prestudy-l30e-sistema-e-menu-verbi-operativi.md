...
- [{{風紀|ふうき}}](term:term-v667-fuuki) — disciplina e ordine scolastico
- [{{受|う}}けとり{{可能|かのう}}](term:term-v668-uketorikanou) — disponibile per la ricezione
- [{{受|う}}けとり{{済|ず}}み](term:term-v669-uketorizumi) — già ricevuto / già riscattato
- [{{項目|こうもく}}](term:term-v670-koumoku) — voce di menu / elemento di elenco
- [{{共闘|きょうとう}}](term:term-v671-kyoutou) — combattere insieme
- [{{困難|こんなん}}](term:term-v672-konnan) — difficoltà reale / ostacolo complesso
- [{{滑空|かっくう}}する](term:term-v673-kakkuu-suru) — planare
- [{{追|お}}いはらう](term:term-v674-oiharau) — scacciare / mandare via
- [{{切|き}}り{{替|か}}える](term:term-v675-kirikaeru) — commutare, cambiare modalità o visualizzazione
- [{{振|ふ}}る{{舞|ま}}う](term:term-v676-furu-mau) — offrire / servire qualcosa a qualcuno
- [{{常設|じょうせつ}}](term:term-v677-jousetsu) — disponibile stabilmente
- [{{買|か}}い{{取|と}}り](term:term-v678-kaitori) — acquisto da parte del negozio
- [{{最適解|さいてきかい}}](term:term-v679-saitekikai) — soluzione ottimale
- [{{腕|うで}}を{{磨|みが}}く](term:term-v680-ude-wo-migaku) — affinare le proprie capacità
- [{{一苦労|ひとくろう}}](term:term-v681-hitokurou) — una bella fatica
- [{{縦横無尽|じゅうおうむじん}}](term:term-v682-juuoumujin) — liberamente, in ogni direzione
- [{{予感|よかん}}](term:term-v683-yokan) — presentimento
...
- [{{全選択|ぜんせんたく}}](term:term-v665-zensentaku) — comando che allarga
  l'azione a tutte le voci disponibili
- [{{受|う}}けとり{{可能|かのう}}](term:term-v668-uketorikanou) — stato ancora
  aperto: il premio o contenuto si può ricevere
- [{{受|う}}けとり{{済|ず}}み](term:term-v669-uketorizumi) — stato chiuso:
  l'azione di ricezione è già stata completata
- [まとめ{{売|う}}り](term:term-v664-matomeuri) — vendita in blocco, non scelta
  qualitativa
- [{{常設|じょうせつ}}](term:term-v677-jousetsu) — contenuto o funzione sempre
  disponibile, non evento temporaneo
- [{{最適解|さいてきかい}}](term:term-v679-saitekikai) — soluzione ottimale, diversa
  da una selezione totale
...
translation_it: >-
  Il Dono Segreto è disponibile per la ricezione.
:::
...
:::example_sentence
jp: >-
  どの {{技|わざ}}を {{回復|かいふく}}する？
translation_it: >-
  Quale mossa vuoi recuperare?
:::
...
:::example_sentence
jp: >-
  {{先生|せんせい}}が {{生徒|せいと}}を {{座|すわ}}らせる。
translation_it: >-
  L'insegnante fa sedere gli studenti.
:::
...
:::example_sentence
jp: >-
  この バトルでは でんきタイプが {{最適解|さいてきかい}}です。
translation_it: >-
