...
difficulty: custom
status: active
tags: [pokemon, scarlet-violet, prestudy, anki-sequence, lesson-05]
prerequisites: []
summary: >-
  Leggere rapporti scolastici, stati interiori e pronomi marcati: chi parla,
...
- [{{疲|つか}}れる](term:term-anki-l05-tsukareru) — stancarsi
- [{{報|ほう}}{{告|こく}}](term:term-anki-l05-houkoku) — rapporto / segnalazione formale
...
- [{{報|ほう}}{{告|こく}}する](term:term-anki-l05-houkoku) — fare rapporto / segnalare
- [{{気|き}}になる](term:term-anki-l05-kininaru) — qualcosa attira l'attenzione senza lasciarti tranquillo
- `Vることがある` — capita che V succeda / a volte V accade
- [{{正|ただ}}しい](term:term-anki-l05-tadashii){{答|こた}}え — risposta corretta

## Pattern grammaticali chiave

- [が](grammar:grammar-g026-marca-il-soggetto-evidenzia-cio-che-impo) — soggetto o cosa che emerge nella frase
- [を](grammar:grammar-g033-marca-l-oggetto-diretto) — oggetto appreso, scelto o riferito
- [に](grammar:grammar-g029-destinazione-tempo-bersaglio-esistenza) — destinatario, bersaglio o punto di esistenza
...
:::example_sentence
jp: >-
  アカデミーの{{皆|みな}}さん、{{今日|きょう}}はポケモンの{{生態|せいたい}}について{{学|まな}}びます。
translation_it: >-
  Studenti dell'Accademia, oggi impariamo l'ecologia dei Pokémon.
:::
...
## 2. Stanchezza, curiosità e calamità: quando la frase pesa
...
:::example_sentence
jp: >-
  バトルが{{長|なが}}くなると、ポケモンが{{疲|つか}}れることがある。
translation_it: >-
  Quando la lotta si allunga, a volte il Pokémon si stanca.
:::
...
Le stesse parole diventano più chiare quando le leggi come parte di una scena: un annuncio dell'Accademia, un resoconto al preside, una curiosità legata al mistero o una battuta aggressiva.

:::example_sentence
jp: >-
  {{皆|みな}}さん、{{正|ただ}}しい{{答|こた}}えを{{選|えら}}んでください。
translation_it: >-
  Tutti voi, scegliete la risposta corretta.
:::
...
:::example_sentence
jp: >-
  {{貴|き}}{{様|さま}}、その{{報|ほう}}{{告|こく}}をジャマする{{気|き}}か！
translation_it: >-
  Maledetto, hai intenzione di ostacolare quel rapporto?!
:::
...
Quando il testo passa dalla scuola al mistero o allo scontro, segui prima le particelle e poi il registro. [を](grammar:grammar-g033-marca-l-oggetto-diretto) ti mostra che cosa viene scelto, studiato o riferito; [に](grammar:grammar-g029-destinazione-tempo-bersaglio-esistenza) ti mostra a chi arriva l'informazione; [が](grammar:grammar-g026-marca-il-soggetto-evidenzia-cio-che-impo) fa emergere ciò che si stanca, preoccupa o cattura l'attenzione. I pronomi completano il quadro: prima ancora del contenuto, ti dicono che tipo di rapporto umano sta parlando sulla schermata.
