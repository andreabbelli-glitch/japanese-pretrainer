...
- `{{確認|かくにん}}して` -> richiesta informale: "controlla / verifica", coerente con un consiglio operativo.
...
- `その {{行動|こうどう}}には` -> cornice: "quanto a quel comportamento", con `には` che prepara l'esistenza o meno di qualcosa.
...
- [それって](term:term-e054-sorette) riprende un elemento appena nominato: "quella cosa di cui parli...". È utile quando il personaggio vuole verificare o rilanciare una notizia.
- [ってことは](term:term-e056-ttekotoha) trasforma ciò che precede in una deduzione: "se è così, allora vuol dire che...".
- [またね](term:term-e055-matane) chiude in modo leggero: `また` (*di nuovo*) + `ね` di tono condiviso, quindi "ci si vede / a dopo".
...
[～だっけ](grammar:grammar-g058-comera-gia-dovera) serve quando il parlante recupera un'informazione già nota ma non perfettamente presente. Con nomi e frasi nominali, `Nだっけ` suona come "era N, vero? / com'era già?". In un dialogo scolastico o su una mappa, questa forma ti segnala memoria incerta, non ignoranza totale.
...
> [!WARNING]
> **⚠️ Non trasformare ogni finale in domanda diretta:** `かなあ`, `かしら` e `だっけ` possono tutti finire con punto interrogativo in traduzione, ma fanno lavori diversi. `かなあ` valuta, `かしら` si domanda con tono morbido, `だっけ` recupera un ricordo incerto.
