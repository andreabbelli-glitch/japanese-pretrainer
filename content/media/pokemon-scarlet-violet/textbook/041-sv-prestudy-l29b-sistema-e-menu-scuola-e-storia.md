---
id: lesson-pokemon-scarlet-violet-sv-prestudy-041-sv-prestudy-l29b-sistema-e-menu-scuola-e-storia
media_id: media-pokemon-scarlet-violet
slug: 041-sv-prestudy-l29b-sistema-e-menu-scuola-e-storia
title: "Menu, Accademia e lotte: leggere la cornice prima dell'azione"
order: 71
...
- [{{商品|しょうひん}}](term:term-v512-shouhin) — prodotto in shop o lista acquisti
- [{{注文|ちゅうもん}}](term:term-v529-chuumon) — ordine da fare, confermare o annullare
- [{{受|う}}けとり](term:term-v532-uketori) — ritiro / ricezione da menu
- [{{追加|ついか}}](term:term-v517-tsuika) — aggiunta a lista, squadra o opzione
- [{{自動|じどう}}](term:term-v538-jidou) — automatico
- [{{便利|べんり}}](term:term-v526-benri) — comodo / utile in senso pratico
- [おこづかい](term:term-v533-okozukai) — paghetta / soldi a disposizione
- [{{入学|にゅうがく}}](term:term-v528-nyuugaku) — ingresso o iscrizione a scuola
- [{{教室|きょうしつ}}](term:term-v521-kyoushitsu) — aula
- [{{部室|ぶしつ}}](term:term-v520-bushitsu) — stanza del club
- [{{制服|せいふく}}](term:term-v534-seifuku) — uniforme
- [{{部活|ぶかつ}}](term:term-v535-bukatsu) — attività di club
- [{{先輩|せんぱい}}](term:term-v531-senpai) — senpai / studente più grande
- [{{返事|へんじ}}](term:term-v537-henji) — risposta
- [{{集中|しゅうちゅう}}](term:term-v516-shuuchuu) — concentrazione
- [{{自然|しぜん}}](term:term-v514-shizen) — natura come ambiente
- [{{性格|せいかく}}](term:term-v527-seikaku) — natura / personalità del Pokémon
- [{{与|あた}}える](term:term-v510-atae-ru) — dare, concedere, infliggere
- [{{応援|おうえん}}](term:term-v539-ouen) — incoraggiamento / supporto

## Espressioni ricorrenti

- [これでＯＫ](term:term-e096-korede-okee) — così va bene / conferma finale
- `{{注文|ちゅうもん}}する` — fare un ordine
- `{{受|う}}けとりを{{選|えら}}ぶ` — scegliere il ritiro
- `{{追加|ついか}}する` / `{{追加|ついか}}されました` — aggiungere / è stato aggiunto
- `{{自動|じどう}}セーブ` — salvataggio automatico
- `{{返事|へんじ}}をする` — rispondere
- `ダメージを{{与|あた}}える` — infliggere danni

## Pattern grammaticali chiave

- [～なら](grammar:grammar-g072-se-e-cosi-se-parli-di) — se è così / se parli di...
- [～される](grammar:grammar-g087-forma-passiva) — forma passiva o risultato subito
- [に](grammar:grammar-g029-destinazione-tempo-bersaglio-esistenza) / [へ](grammar:grammar-g032-verso) — destinazione, bersaglio o direzione
- [で](grammar:grammar-g027-luogo-dell-azione-mezzo) — luogo o mezzo dell'azione
...
- [{{生徒会長|せいとかいちょう}}](term:term-v519-seitokaichou) — presidente del consiglio studentesco
- [{{助手|じょしゅ}}](term:term-v518-joshu) — assistente
- [{{支援|しえん}}](term:term-v523-shien) — supporto organizzato
- [{{灯台|とうだい}}](term:term-v524-toudai) — faro
- [{{記念|きねん}}](term:term-v525-kinen) — ricordo / commemorazione
- [{{素敵|すてき}}](term:term-v522-suteki) — bello / splendido
- [したっぱ](term:term-v530-shitappa) — recluta / sottoposto
...
*   `これでＯＫなら` ➔ **Condizione di conferma** (`これで` = con questa configurazione; `なら` = se è così).
...
*   `マップの {{検索|けんさく}}{{機能|きのう}}` ➔ **Specificazione con `の`**: non tutta la mappa, ma la funzione di ricerca della mappa.
...
*   `グレープアカデミーに` ➔ **Destinazione istituzionale**: `に` marca il luogo in cui entri come studente.
*   `{{入学|にゅうがく}}して` ➔ **Azione collegata**: `する` trasforma il sostantivo in verbo; `して` lo lega al movimento successivo.
*   `{{教室|きょうしつ}}へ {{向|む}}かいます` ➔ **Direzione**: `へ` punta verso l'aula; non dice ancora che sei già dentro.

:::example_sentence
jp: >-
  {{放課後|ほうかご}}に {{部活|ぶかつ}}へ {{参加|さんか}}して、{{部室|ぶしつ}}で {{先輩|せんぱい}}の {{返事|へんじ}}を {{待|ま}}ちます。
translation_it: >-
  Dopo le lezioni partecipo al club e aspetto la risposta del senpai nella stanza del club.
:::

#### 🗺️ Anatomia della frase

*   `{{放課後|ほうかご}}に` ➔ **Tempo della scena**: `に` colloca l'azione dopo le lezioni.
*   `{{部活|ぶかつ}}へ {{参加|さんか}}して` ➔ **Ingresso nell'attività**: il club è la cornice sociale; `して` collega partecipazione e attesa.
*   `{{部室|ぶしつ}}で` ➔ **Luogo dell'azione**: `で` marca dove avviene l'attesa.
*   `{{先輩|せんぱい}}の {{返事|へんじ}}を {{待|ま}}ちます` ➔ **Oggetto atteso**: `の` lega la risposta al senpai, `を` la rende ciò che stai aspettando.

:::example_sentence
jp: >-
  {{授業中|じゅぎょうちゅう}}は {{先生|せんせい}}の {{説明|せつめい}}に {{集中|しゅうちゅう}}します。
translation_it: >-
...
*   `{{入学|にゅうがく}}の {{記念|きねん}}に` ➔ **Motivo o occasione**: `の` lega il ricordo all'ingresso a scuola; `に` dà il motivo dell'azione.
*   `{{宝食堂|たからしょくどう}}で` ➔ **Luogo dell'azione**: il ristorante è dove avviene lo scatto.
*   `{{写真|しゃしん}}を {{撮|と}}ります` ➔ **Azione concreta**: `を` marca la foto come oggetto prodotto dall'azione.

:::example_sentence
jp: >-
  {{研究所|けんきゅうじょ}}の {{助手|じょしゅ}}が {{新入生|しんにゅうせい}}を {{支援|しえん}}します。
translation_it: >-
  L'assistente del laboratorio supporta i nuovi studenti.
:::
...
:::example_sentence
jp: >-
  レイドバトルに エントリーする{{前|まえ}}に、バトルチームを {{確認|かくにん}}します。
translation_it: >-
  Prima di iscrivermi al raid battle, controllo il battle team.
:::

#### 🗺️ Anatomia della frase

*   `レイドバトルに` ➔ **Evento di destinazione**: `に` marca l'evento a cui ci si registra.
*   `エントリーする{{前|まえ}}に` ➔ **Timing prima dell'azione**: il controllo avviene prima dell'iscrizione.
*   `バトルチームを {{確認|かくにん}}します` ➔ **Oggetto del controllo**: controlli la squadra da lotta, non il raid stesso.
...
:::example_sentence
jp: >-
  {{灯台|とうだい}}へ {{向|む}}かう{{前|まえ}}に、ポケモンの {{性格|せいかく}}と バトルチームを {{確認|かくにん}}します。
translation_it: >-
  Prima di dirigermi al faro, controllo la natura del Pokémon e il battle team.
:::

:::example_sentence
jp: >-
  レイドバトルで {{味方|みかた}}を {{応援|おうえん}}して、{{相手|あいて}}に ダメージを {{与|あた}}えます。
translation_it: >-
  Nel raid battle supporto gli alleati e infliggo danni all'avversario.
:::
...
La schermata diventa leggibile quando separi cornice, azione e bersaglio. [これでＯＫ](term:term-e096-korede-okee) chiude una scelta; [{{注文|ちゅうもん}}](term:term-v529-chuumon), [{{受|う}}けとり](term:term-v532-uketori) e [{{追加|ついか}}](term:term-v517-tsuika) distinguono ordine, ritiro e risultato su lista; [{{教室|きょうしつ}}](term:term-v521-kyoushitsu), [{{部室|ぶしつ}}](term:term-v520-bushitsu), [{{宝食堂|たからしょくどう}}](term:term-v509-takarashokudou) e [{{灯台|とうだい}}](term:term-v524-toudai) preparano scene diverse; [{{自然|しぜん}}](term:term-v514-shizen), [{{性格|せいかく}}](term:term-v527-seikaku), [{{与|あた}}える](term:term-v510-atae-ru) e [{{応援|おうえん}}](term:term-v539-ouen) cambiano lettura quando passi dalla storia alla lotta.
