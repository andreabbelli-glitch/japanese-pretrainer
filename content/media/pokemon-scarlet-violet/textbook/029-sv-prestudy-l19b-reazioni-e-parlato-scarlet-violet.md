...
- [{{古代|こだい}}](term:term-v255-kodai) — antichità / passato remoto
- [フェアリー](term:term-v256-fearii) — folletto
- [はがね](term:term-v257-hagane) — acciaio
- [{{味方|みかた}}](term:term-v258-mikata) — alleato
- [なみのり](term:term-v260-naminori) — surf / cavalcare le onde
- [{{注意|ちゅうい}}](term:term-v261-chuui) — attenzione / cautela
- [{{受|う}}ける](term:term-v262-ukeru) — ricevere / sostenere
- [{{家庭科|かていか}}](term:term-v263-kateika) — economia domestica
- [レシピ](term:term-v264-reshipi) — ricetta
- [ひこう](term:term-v265-hikou) — volo
- [{{全部|ぜんぶ}}](term:term-v266-zenbu) — tutto
- [{{通信|つうしん}}](term:term-v267-tsuushin) — connessione / comunicazione
- [{{普通|ふつう}}](term:term-v268-futsuu) — normale
- [{{結果|けっか}}](term:term-v269-kekka) — risultato
- [せっかく](term:term-v270-sekkaku) — occasione da non sprecare / già che
- [{{約束|やくそく}}](term:term-v271-yakusoku) — promessa / appuntamento
- [かくとう](term:term-v273-kakutou) — lotta

## Espressioni ricorrenti

- [〜を {{受|う}}けとりました！](term:term-e046-o-uketorimashita) — hai ricevuto ...!
- [〜を {{選|えら}}んでください](term:term-e047-o-erandekudasai) — seleziona ...
