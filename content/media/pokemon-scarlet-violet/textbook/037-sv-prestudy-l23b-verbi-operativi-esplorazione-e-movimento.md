...
- [{{奥|おく}}](term:term-v415-oku) — in fondo / all'interno
- [{{逃|に}}げる](term:term-v416-nige-ru) — fuggire
- [{{助|たす}}ける](term:term-v417-tasuke-ru) — aiutare / salvare
...
- [{{触|ふ}}れる](term:term-v426-fureru) — toccare / entrare in contatto
- [{{何度|なんど}}でも](term:term-v427-nando-demo) — quante volte vuoi
- [{{乗|の}}る](term:term-v428-noru) — salire / cavalcare
- [おまかせ{{回復|かいふく}}](term:term-v429-omakasekaifuku) — cura automatica
- [{{湖|みずうみ}}](term:term-v430-mizuumi) — lago
- [{{発動|はつどう}}](term:term-v431-hatsudou) — attivazione

## Espressioni ricorrenti

- [{{早|はや}}く！](term:term-e078-hayaku) — presto!
- [{{次|つぎ}}はだれ？](term:term-e079-tsugi-hadare) — chi è il prossimo?
- [{{無理|むり}}しないで](term:term-e080-muri-shinaide) — non esagerare

## Pattern grammaticali chiave

- [～なくてもいい](grammar:grammar-g082-non-e-necessario-fare) — non è necessario fare
- [{{辞書形|じしょけい}} + な](grammar:grammar-g083-non-fare-ordine-secco) — non fare! (ordine secco)
- [finali di frase よ / ね / な](grammar:grammar-g084-enfasi-conferma-tono-emotivo) — enfasi / conferma / tono emotivo
...
:::example_sentence
jp: >-
  {{奥|おく}}へ {{進|すす}}んで、{{味方|みかた}}を {{助|たす}}ける。
translation_it: >-
  Avanzi verso il fondo e aiuti l'alleato.
:::
...
:::example_sentence
jp: >-
  バトルが あっという{{間|ま}}に {{終|お}}わって、レシピを {{受|う}}けとる。
translation_it: >-
  La battaglia finisce in un attimo e ricevi la ricetta.
:::
...
:::example_sentence
jp: >-
  {{湖|みずうみ}}の {{近|ちか}}くで、ライドポケモンに {{乗|の}}る。
translation_it: >-
  Vicino al lago, salgo sul Pokémon cavalcatura.
:::
...
:::example_sentence
jp: >-
  {{早|はや}}く！でも、{{無理|むり}}しないで。
translation_it: >-
  Presto! Però non esagerare.
:::
...
:::example_sentence
jp: >-
  {{奥|おく}}へ {{進|すす}}む。{{逃|に}}げるな。
translation_it: >-
  Avanza verso il fondo. Non fuggire.
:::

:::example_sentence
jp: >-
  {{何度|なんど}}でも おまかせ{{回復|かいふく}}を {{使|つか}}えるよ。
translation_it: >-
  Puoi usare la cura automatica quante volte vuoi.
:::
...
jp: >-
  ようやく バトルが {{終|お}}わったね。
translation_it: >-
  Finalmente la battaglia è finita, eh.
:::
