...
difficulty: custom
status: active
tags: [pokemon, scarlet-violet, prestudy, anki-sequence, lesson-18]
prerequisites: []
summary: >-
...
- [エリアゼロ](term:term-v022-eriazero) — luogo centrale di ricerca, mistero e rivelazione
- [ジムテスト](term:term-v038-jimutesuto) — prova preliminare prima della palestra
- [テラスタル](term:term-terastal) — fenomeno legato a luce, cambio di stato e battaglia
- [チャンピオンランク](term:term-champion-rank) — traguardo istituzionale della route palestre

---

[ジムテスト](term:term-v038-jimutesuto) indica la prova prima della palestra; [チャンピオンランク](term:term-champion-rank) sposta la lettura sul traguardo istituzionale della Lega.
...
*   `とても` ➔ **Intensità** (rafforza la qualità senza cambiare il tipo di
    giudizio).
*   `{{興味|きょうみ}}{{深|ぶか}}い ね` ➔ **Interesse condiviso** (l'aggettivo
    valuta la tradizione come degna di indagine; `ね` cerca accordo con chi
    ascolta).
...
Nel percorso palestra e nella Lega, il testo non parla solo di emozioni: assegna obiettivi e status. [やる{{気|き}}](term:term-anki-l18-yaruki) unisce やる "fare" e {{気|き}} "spirito, disposizione mentale"; indica la spinta concreta a passare all'azione. Con がある quella spinta è presente, con が{{出|で}}る emerge, con を{{出|だ}}す viene tirata fuori intenzionalmente.
...
Il passo successivo è [{{活躍|かつやく}}](term:term-anki-l18-katsuyaku). `活躍` descrive distinguersi attraverso un'azione visibile. In formule come {{活躍|かつやく}}を{{期待|きたい}}している, chi parla non sta solo facendo un complimento; sta proiettando su di te un ruolo futuro.
...
Le stesse forme diventano più riconoscibili quando le leggi come piccoli sistemi: registro, soggetto, stato e ruolo.
