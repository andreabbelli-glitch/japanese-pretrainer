...
difficulty: custom
status: active
tags: [pokemon, scarlet-violet, prestudy, anki-sequence, lesson-20]
prerequisites: []
summary: >-
...
- [{{同|どう}}{{胞|ほう}}](term:term-anki-l20-douhou) — compagno; fratello
...
frase direttamente, ma quando descrive lo stato interiore di una terza persona
il giapponese tende a usare segnali di apparenza o comportamento, come
`{{悲|かな}}しそう` "sembra triste" o `{{悲|かな}}しんでいる` "sta provando
tristezza".
...
:::example_sentence
jp: >-
  {{草|くさ}}むらから {{突|とつ}}{{然|ぜん}}、{{野生|やせい}}の ポケモンが とびだしてきた！
translation_it: >-
...
indicare l'essere vivi, [{{暮|く}}らす](term:term-anki-l20-kurasu) guarda il
modo in cui passano le giornate: routine, incontri, abitudini e convivenza. Il
luogo in cui questa vita quotidiana si svolge si marca normalmente con `で`.
...
:::example_sentence
jp: >-
  {{彼|かれ}}らの {{同|どう}}{{胞|ほう}}を {{助|たす}}けられないのは {{悲|かな}}しい。
translation_it: >-
  È triste non riuscire ad aiutare i loro compagni.
:::
...
[{{同|どう}}{{胞|ほう}}](term:term-anki-l20-douhou) e
