...
- [{{思|おも}}い{{出|だ}}す](term:term-omoidasu)
- [{{忘|わす}}れる](term:term-wasureru)
...
[{{並|なら}}び{{替|か}}え](term:term-narabikae),
[{{思|おも}}い{{出|だ}}す](term:term-omoidasu) e
[{{忘|わす}}れる](term:term-wasureru): il primo cambia l'ordine, gli altri
