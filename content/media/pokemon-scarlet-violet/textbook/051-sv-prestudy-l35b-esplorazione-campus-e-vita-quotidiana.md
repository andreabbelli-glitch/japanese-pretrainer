...
- [{{人助|ひとだす}}け](term:term-v743-hitodasuke) — aiutare qualcuno / gesto di aiuto
- [プレゼント](term:term-v744-purezento) — regalo / premio dato
- [{{勝|か}}てる](term:term-v745-kateru) — poter vincere / riuscire a battere
- [{{戻|もど}}れる](term:term-v746-modoreru) — poter tornare
- [{{思|おも}}いつく](term:term-v747-omoitsuku) — avere un'idea / trovare una soluzione
- [{{調味料|ちょうみりょう}}](term:term-v748-choumiryou) — condimento
- [{{天気|てんき}}](term:term-v749-tenki) — tempo atmosferico
- [{{入|い}}り{{組|く}}む](term:term-v750-irikumu) — essere intricato / pieno di svolte
- [{{迷|まよ}}う](term:term-v751-mayou) — perdersi / esitare sulla strada
- [{{相棒|あいぼう}}](term:term-v752-aibou) — partner / compagno fidato
- [{{知|し}}れる](term:term-v753-shireru) — riuscire a conoscere / scoprire
- [なかよし](term:term-v754-nakayoshi) — molto in sintonia / in buoni rapporti
- [{{近況|きんきょう}}](term:term-v755-kinkyou) — aggiornamenti recenti / come vanno le cose
- [{{旅立|たびだ}}つ](term:term-v756-tabidatsu) — partire / mettersi in viaggio
- [{{挑|いど}}める](term:term-v757-idomeru) — poter sfidare
- [おすそわけ](term:term-v758-osusowake) — condividere un po' di ciò che si ha
- [{{休息|きゅうそく}}](term:term-v759-kyuusoku) — pausa / riposo
- [{{自称|じしょう}}](term:term-v760-jishou) — sedicente / che si definisce da solo
- [あやしい](term:term-v761-ayashii) — sospetto / losco

## Espressioni ricorrenti

- [とりあえず](term:term-e109-toriaezu) — per ora / intanto
- [オススメ](term:term-e110-osusume) — consiglio / raccomandazione
...
[{{可能形|かのうけい}}](grammar:grammar-g020-poter-fare) trasforma l'azione in capacità o possibilità; [ヌシ](term:term-v167-nushi) resta invece un'etichetta di mappa, una presenza dominante da riconoscere nel territorio.
...
translation_it: >-
  Pare che il comportamento dei Pokémon selvatici cambi a seconda dell'ora e del meteo.
:::
...
:::example_sentence
jp: >-
  {{人助|ひとだす}}けは いいことだけど ワイルドは ほどほどに。
translation_it: >-
  Aiutare qualcuno è una buona cosa, ma senza esagerare con le iniziative troppo selvagge.
:::
...
Le stesse forme diventano più solide quando si combinano: una rotta consigliata può restare provvisoria, un ritorno può essere solo possibile, un condimento può nascere da un'idea improvvisa e una proposta cortese può suonare sospetta. [テーブルシティ](term:term-v272-teeburushitei) qui funziona come riferimento urbano concreto, mentre [～たら](grammar:grammar-tara) apre una condizione realizzata: quando l'idea arriva, allora puoi passare all'azione.
...
:::example_sentence
jp: >-
  {{調味料|ちょうみりょう}}を {{思|おも}}いついたら、{{休息|きゅうそく}}の
  {{時間|じかん}}に サンドイッチを {{作|つく}}ってみよう。
translation_it: >-
  Se ti viene in mente un condimento, proviamo a preparare un sandwich durante la pausa.
:::

:::example_sentence
jp: >-
  {{相棒|あいぼう}}と {{旅立|たびだ}}って、もっと なかよしに なれると いいね。
translation_it: >-
  Sarebbe bello partire con il tuo compagno e diventare ancora più affiatati.
:::

:::example_sentence
jp: >-
  {{自称|じしょう}} {{最強|さいきょう}}トレーナーに {{挑|いど}}めるけど、
  ちょっと あやしい。
translation_it: >-
  Puoi sfidare un sedicente allenatore fortissimo, ma è un po' sospetto.
:::

#### 🗺️ Anatomia della frase

*   `オススメの {{道|みち}}を {{知|し}}れるなら` ➔ **Condizione possibile**: `なら` costruisce lo scenario "se riesco a sapere".
*   [テーブルシティ](term:term-v272-teeburushitei)に {{戻|もど}}れるか ➔ **Ritorno verificato**: `に` marca la meta urbana, `か` trasforma il ritorno in controllo.
*   `{{調味料|ちょうみりょう}}を {{思|おも}}いついたら` ➔ **Condizione realizzata**: [～たら](grammar:grammar-tara) fa partire l'azione dopo l'idea.
*   `{{相棒|あいぼう}}と {{旅立|たびだ}}って` ➔ **Partenza condivisa**: `と` tiene il compagno dentro l'azione.
*   `{{自称|じしょう}} {{最強|さいきょう}}トレーナーに` ➔ **Bersaglio dichiarato da sé**: l'etichetta resta sospetta già prima di `あやしい`.
