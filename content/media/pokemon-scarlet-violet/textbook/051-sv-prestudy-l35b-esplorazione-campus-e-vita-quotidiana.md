...
- [{{調味料|ちょう.み.りょう}}](term:term-v748-choumiryou) - condimento / seasoning
...
- [おすそわけ](term:term-v758-osusowake) - condividere un po' di cio che si ha
...
[{{天気|てんき}}](term:term-v749-tenki),
[{{入|い}}り{{組|く}}む](term:term-v750-irikumu) e
[{{迷|まよ}}う](term:term-v751-mayou) servono invece a leggere il mondo aperto
come spazio reale. Ti dicono se una zona e facile da percorrere, se conviene
segnarsi un posto, se il terreno confonde e se il meteo cambia il comportamento
del campo.

Il blocco sandwich/picnic introduce un giapponese quotidiano ma molto utile.
[{{思|おも}}いつく](term:term-v747-omoitsuku),
...
[{{勝|か}}てる](term:term-v745-kateru),
[{{挑|いど}}める](term:term-v757-idomeru),
[{{自称|じしょう}}](term:term-v760-jishou) e
[あやしい](term:term-v761-ayashii) ti fanno leggere meglio i piccoli ganci
sociali del mondo: complimenti, ricompense, promesse di riuscita, offerte strane
e NPC che chiaramente non sembrano affidabili.
...
translation_it: >-
  Aiutare qualcuno e una buona cosa, ma senza esagerare con le iniziative troppo selvagge.
:::
...
translation_it: >-
  Pare che il comportamento dei Pokemon selvatici cambi a seconda dell'ora e del meteo.
:::
