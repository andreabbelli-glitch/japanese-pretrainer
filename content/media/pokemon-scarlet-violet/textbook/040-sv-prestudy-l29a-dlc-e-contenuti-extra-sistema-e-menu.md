...
- [{{大好|だいす}}き](term:term-v501-daisuki) — piacere moltissimo / adorare
- [{{看板|かんばん}}](term:term-v502-kanban) — cartello / insegna
- [{{受付|うけつけ}}](term:term-v504-uketsuke) — reception / sportello
- [{{観測|かんそく}}](term:term-v505-kansoku) — osservazione / rilevamento
- [{{開始|かいし}}](term:term-v506-kaishi) — avvio / inizio
- [{{知識|ちしき}}](term:term-v507-chishiki) — conoscenza
- [{{撮影|さつえい}}](term:term-v508-satsuei) — scatto fotografico / ripresa
...
:::example_sentence
jp: >-
  {{看板|かんばん}}の ヒントを {{読|よ}}んで、{{正解|せいかい}}を {{選|えら}}びます。
translation_it: >-
  Leggo l'indizio sul cartello e scelgo la risposta corretta.
:::
