...
prerequisites: []
summary: >-
  Leggere istruzioni, stati di menu e battute colloquiali quando il gioco chiede
...
Anche i dialoghi dell'Accademia e delle funzioni competitive lavorano nello stesso modo. Prima individuano persone, ruoli e luoghi; poi aprono o chiudono possibilità; infine il parlato dei personaggi aggiunge supposizione, invito o sicurezza ruvida.
...
- [{{保存|ほぞん}}](term:term-v619-hozon) — salvataggio / conservazione dei dati
- [{{岩山|いわやま}}](term:term-v620-iwayama) — montagna rocciosa
- [{{連携|れんけい}}](term:term-v621-renkei) — coordinazione / collaborazione
...
- [{{背後|はいご}}](term:term-v626-haigo) — retro / alle spalle
- [ランキング](term:term-v627-rankingu) — classifica
- [{{有利|ゆうり}}](term:term-v628-yuuri) — vantaggioso / favorevole
- [{{広大|こうだい}}](term:term-v629-koudai) — vastissimo / ampio
- [リセット](term:term-v630-risetto) — reset / ripristino
...
## 1. Persone, ruoli e destinazioni dell'Accademia
...
## 2. Azioni di sistema: salvare, bloccare, ritirarsi

Quando il dialogo lascia la scuola e passa ai menu, le parole diventano più compatte. Una voce di menu non racconta tutta la conseguenza: la concentra in un sostantivo o in un katakana breve. Per questo conviene leggere ogni label come un verbo nascosto.
...
## 3. Movimento e spazio: terreno, postura e retro
...
## 4. Schermate competitive: classifica, team e attesa
...
## 5. Parlato colloquiale: opzioni, voci e sicurezza ruvida

Nei dialoghi dei personaggi, le scelte non arrivano sempre come comandi. A volte un personaggio lascia una porta aperta, presenta una voce come indiretta, restringe una finestra temporale o chiude la frase con tono spavaldo.
...
*   `{{気|き}}が {{変|か}}わったら` ➔ **Condizione mentale** (`{{気|き}}` qui è disposizione/intenzione; `{{変|か}}わったら` apre il "se/quando cambia").
*   `よろしくね` ➔ **Formula relazionale** (non traduce una sola parola italiana; qui vale come "contaci / fammelo sapere / ci conto").
...
*   `もう {{来|き}}た` ➔ **Evento completato** (`もう` + passato: l'arrivo è già avvenuto).
*   `らしい` ➔ **Evidenza indiretta** (il parlante presenta il fatto come "pare che", non come esperienza diretta).
...
*   `{{連携|れんけい}}すれば` ➔ **Condizione** (`すれば` crea il "se": se agiamo in coordinazione).
...
Quando menu, scuola e parlato si incrociano, cerca prima la funzione della frase: chi è coinvolto, quale azione viene chiesta, dove avviene il movimento e quanto è diretto il tono.
