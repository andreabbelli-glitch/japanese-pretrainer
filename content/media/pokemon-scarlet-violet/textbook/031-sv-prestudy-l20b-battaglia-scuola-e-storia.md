...
:::example_sentence
jp: >-
  あくタイプの わざは エスパータイプの {{相手|あいて}}に {{強|つよ}}そうだ。
translation_it: >-
  Una mossa di tipo Buio sembra forte contro un avversario di tipo Psico.
:::
...
:::example_sentence
jp: >-
  {{今日|きょう}}の {{数学|すうがく}}の {{授業|じゅぎょう}}は {{楽|たの}}しすぎる。
translation_it: >-
  La lezione di matematica di oggi è fin troppo divertente.
:::
