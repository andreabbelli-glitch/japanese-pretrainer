...
- [{{冒険|ぼうけん}}](term:term-v063-bouken) — avventura / viaggio
- [{{道具|どうぐ}}](term:term-v065-dougu) — strumento / oggetto
- [{{使|つか}}う](term:term-v066-tsukau) — usare
- [{{技|わざ}}](term:term-v067-waza) — mossa / tecnica
- [{{移動|いどう}}](term:term-v071-idou) — spostamento / movimento
- [{{何|なに}}](term:term-v072-nani) — cosa / che cosa
- [マップ](term:term-v073-mappu) — mappa
- [{{行|い}}く](term:term-v074-iku) — andare
- [{{素早|すばや}}さ](term:term-v075-subayasa) — velocità / rapidità

## Espressioni ricorrenti

- [この{{先|さき}}](term:term-e010-kono-saki) — più avanti / da qui in poi
- [こっち](term:term-e011-kocchi) — da questa parte / verso chi parla
- [よろしくね](term:term-e014-yoroshikune) — conto su di te / ci intendiamo
- [よろしくお{{願|ねが}}いします](term:term-e015-yoroshikuo-negai-shimasu) — conto sulla sua collaborazione / la ringrazio in anticipo

## Pattern grammaticali chiave

- [～と{{思|おも}}う](grammar:grammar-g017-pensare-che) — pensare che / credere che
- [～てはいけない / ～ちゃいけない](grammar:grammar-g018-non-si-deve) — non si deve / non è permesso
...
*   `この{{先|さき}}に` ➔ **Collocazione davanti a te** (`に` marca il punto in cui qualcosa si trova: non "verso", ma "là, più avanti").
...
jp: >-
  ポケモンの {{技|わざ}}を {{使|つか}}う。
translation_it: >-
  Usa una mossa del Pokémon.
:::

#### 🗺️ Anatomia della frase

*   `ポケモンの` ➔ **Possesso o appartenenza** (`の` collega la mossa al Pokémon).
*   `{{技|わざ}}を` ➔ **Oggetto dell'azione** (la mossa è ciò che viene usato).
*   `{{使|つか}}う` ➔ **Verbo operativo** (nel menu non descrive solo un'abitudine: apre l'azione concreta).
...
:::example_sentence
jp: >-
  マップを {{使|つか}}って {{移動|いどう}}しよう。
translation_it: >-
  Spostiamoci usando la mappa.
:::

#### 🗺️ Anatomia della frase

*   `マップを` ➔ **Strumento usato come oggetto** (`を` marca ciò che attivi o consulti).
...
:::example_sentence
jp: >-
  ポケモンの {{素早|すばや}}さが {{上|あ}}がった。
translation_it: >-
  La velocità del Pokémon è aumentata.
:::

#### 🗺️ Anatomia della frase

*   `ポケモンの` ➔ **Campo di appartenenza** (la statistica appartiene a quel Pokémon).
...
*   `これから` ➔ **Punto di partenza temporale** ("da adesso in poi").
...
:::example_sentence
jp: >-
  この{{先|さき}}へ {{行|い}}っちゃいけないと {{思|おも}}う。
translation_it: >-
  Penso che non si debba andare oltre questo punto.
:::

#### 🗺️ Anatomia della frase

*   `この{{先|さき}}へ` ➔ **Direzione oltre il punto attuale** (`へ` orienta il movimento verso il tratto davanti).
*   `{{行|い}}っちゃいけない` ➔ **Divieto colloquiale** (`{{行|い}}ってはいけない` contratto: "non si deve andare").
...
Le stesse forme si ricombinano mentre passi da cartelli, mappa, menu e dialoghi:
...
:::example_sentence
jp: >-
  この{{先|さき}}に {{何|なに}}が あると {{思|おも}}う？
translation_it: >-
  Che cosa pensi ci sia più avanti?
:::

:::example_sentence
jp: >-
  {{道具|どうぐ}}を {{使|つか}}ってから、 ポケモンの {{技|わざ}}を {{選|えら}}ぶ。
translation_it: >-
  Dopo aver usato uno strumento, scegli una mossa del Pokémon.
:::
...
Durante l'esplorazione, leggi prima la funzione della frase: [この{{先|さき}}](term:term-e010-kono-saki) e [こっち](term:term-e011-kocchi) orientano, [{{道具|どうぐ}}](term:term-v065-dougu) e [{{使|つか}}う](term:term-v066-tsukau) aprono azioni da menu, [マップ](term:term-v073-mappu) e [{{移動|いどう}}](term:term-v071-idou) gestiscono lo spostamento, [～と{{思|おも}}う](grammar:grammar-g017-pensare-che) segnala una supposizione e [～ちゃいけない](grammar:grammar-g018-non-si-deve) mette un limite. Le particelle ti dicono il resto: dove sei, dove vai e che cosa il gioco ti sta chiedendo di fare.
