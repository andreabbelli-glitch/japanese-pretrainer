---
id: lesson-duel-masters-dm25-live-duel-encounters-nothing-zero-secret-destruction
media_id: media-duel-masters-dm25
slug: live-duel-encounters-nothing-zero-secret-destruction
title: "Rivelare, contare e rimettere: 破界秘伝ナッシング・ゼロ"
order: 86
segment_ref: live-duel-encounters
difficulty: n3
status: active
tags: [live-duel, card-encounter, spell, reveal, deck-order, duel-masters]
prerequisites: [lesson-duel-masters-dm25-tcg-core-patterns]
summary: >-
  Leggere reveal pubblico, conteggio per carta incolore mostrata e scelta tra
  cima o fondo del deck.
---

# Rivelare, contare e rimettere: 破界秘伝ナッシング・ゼロ

{{破界秘伝|はかいひでん}}ナッシング・ゼロ legge il [{{山札|やまふだ}}](term:term-deck) come una pila fisica: prima prende le carte dalla cima, poi le rende visibili a tutti, poi usa proprio quel gruppo per calcolare un aumento di break.
...
- [さらに](term:term-sarani) — in più, ulteriore; aumenta un risultato già previsto.
- [すべて](term:term-subete) — tutto / senza eccezioni dentro il gruppo già definito.
- [{{戻|もど}}す](term:term-modosu) — rimettere / riportare una carta in una zona precedente o indicata.

## Espressioni ricorrenti

- [こうして{{見|み}}せた{{無色|むしょく}}カード{{1枚|いちまい}}につき](grammar:grammar-koushite-misetamushoku-card-1-nitsuki) — per ogni carta incolore mostrata in questo modo.
- [{{見|み}}せたカードはすべて](grammar:grammar-misetakado-wa-subete) — tutte le carte mostrate, senza lasciare fuori nulla del gruppo.
...
La prima riga costruisce una procedura molto ordinata: chi possiede il deck, da quale punto della pila si prendono le carte, quante sono, e a chi vengono mostrate. Il verbo `{{見|み}}せる` è semplice, ma qui non significa "guardare per sé": significa rendere visibile qualcosa a un destinatario.

:::example_sentence
jp: >-
  [{{自分|じぶん}}](term:term-self)の[{{山札|やまふだ}}](term:term-deck)の{{上|うえ}}から{{3枚|さんまい}}をすべてのプレイヤーに{{見|み}}せる。
translation_it: >-
  Mostra le prime 3 carte del tuo deck a tutti i giocatori.
...
Come trucco mnemonico, pensa a `{{見|み}}せる` come a `{{見|み}}る` spinto verso un destinatario: non "vedo", ma "faccio vedere". Non è un'etimologia completa, è solo un modo rapido per ricordare perché la particella `に` porta ai player.

## 2. Il conteggio carta per carta: `こうして...につき`

Dopo il reveal, il testo non ricomincia da zero. `こうして` aggancia la frase alla procedura appena completata: le carte da contare sono proprio quelle mostrate dalla cima del deck. Dentro quel gruppo, il filtro è `{{無色|むしょく}}カード`, e `{{1枚|いちまい}}につき` trasforma ogni carta valida in un'unità di payoff.

:::example_sentence
jp: >-
  [こうして{{見|み}}せた{{無色|むしょく}}カード{{1枚|いちまい}}につき](grammar:grammar-koushite-misetamushoku-card-1-nitsuki)、
  このターン、[バトルゾーン](term:term-battle-zone)にある[{{自分|じぶん}}](term:term-self)の[クリーチャー](term:term-creature){{1体|いったい}}は
  シールドを[さらに](term:term-sarani){{1枚|いちまい}}[ブレイク](term:term-break)する。
translation_it: >-
...
`{{1枚|いちまい}}につき` distribuisce il risultato per ogni carta incolore mostrata. Se ne mostri due, leggi due unità di bonus; se non ne mostri nessuna, non c'è nessuna unità da applicare. La frase non dice "se c'è almeno una carta incolore", perché il numero di carte valide cambia direttamente il numero di scudi extra.
...
:::example_sentence
jp: >-
  [{{見|み}}せたカードはすべて](grammar:grammar-misetakado-wa-subete)、[{{好|す}}きな{{順序|じゅんじょ}}で](grammar:grammar-sukina-junjo-de)[{{自分|じぶん}}](term:term-self)の[{{山札|やまふだ}}](term:term-deck)の{{上|うえ}}か
  {{下|した}}のどちらかに[{{戻|もど}}す](term:term-modosu)。
translation_it: >-
...
*   [{{好|す}}きな{{順序|じゅんじょ}}で](grammar:grammar-sukina-junjo-de) risponde alla domanda "in che ordine rimetto queste carte?".
*   [{{山札|やまふだ}}の{{上|うえ}}か{{下|した}}のどちらかに{{戻|もど}}す](grammar:grammar-yamafuda-no-ue-ka-shita-no-dochiraka-ni-modosu) risponde alla domanda "le rimetto sopra o sotto?".
*   `どちらか` non significa "entrambe le parti". Significa una tra due: cima oppure fondo.

#### 🧠 Gancio cognitivo

Puoi visualizzare la frase come due manopole. La prima manopola, `{{好|す}}きな{{順序|じゅんじょ}}`, regola l'ordine del mazzetto rivelato. La seconda, `どちらか`, scatta solo su due posizioni: `{{上|うえ}}` o `{{下|した}}`.

## Esempi guidati di riepilogo

Le tre frasi della spell diventano più facili quando le leggi come una catena: fonte del reveal, conteggio del payoff, cleanup del gruppo.

:::example_sentence
jp: >-
  [{{山札|やまふだ}}](term:term-deck)の{{上|うえ}}から{{3枚|さんまい}}をすべてのプレイヤーに{{見|み}}せる。
translation_it: >-
  Mostri 3 carte dalla cima del deck a tutti i player.
reveal_mode: sentence
:::

:::example_sentence
jp: >-
  [こうして{{見|み}}せた{{無色|むしょく}}カード{{1枚|いちまい}}につき](grammar:grammar-koushite-misetamushoku-card-1-nitsuki)、シールドを[さらに](term:term-sarani){{1枚|いちまい}}[ブレイク](term:term-break)する。
translation_it: >-
  Per ogni carta incolore mostrata in questo modo, rompi uno scudo in più.
reveal_mode: sentence
:::

:::example_sentence
jp: >-
  [{{見|み}}せたカードはすべて](grammar:grammar-misetakado-wa-subete)、[{{好|す}}きな{{順序|じゅんじょ}}で](grammar:grammar-sukina-junjo-de)[{{山札|やまふだ}}](term:term-deck)の{{上|うえ}}か{{下|した}}のどちらかに[{{戻|もど}}す](term:term-modosu)。
translation_it: >-
  Tutte le carte mostrate tornano nel deck, nell'ordine scelto, sopra oppure
  sotto.
reveal_mode: sentence
:::
