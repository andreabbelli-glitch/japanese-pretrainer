...
title: "Diamond Sword: leggere i divieti d'attacco che diventano nulli"
order: 87
...
summary: >-
  Leggere come Diamond Sword rende nulli gli effetti che impediscono alle tue
  creature di attaccare il giocatore avversario.
---
...
Il giapponese è lungo perché deve evitare due letture sbagliate: non sta rendendo valide tutte le forme di attacco, e non sta cambiando ogni creatura in una creatura “senza restrizioni”. Sta nominando gli [{{効果|こうか}}](term:term-effect) che vietano un bersaglio specifico, poi li annulla con [{{無効|むこう}}](term:term-mukou)になる.

## Termini chiave

- [{{自分|じぶん}}](term:term-self) — il giocatore che controlla la spell e le creature coinvolte.
- [{{相手|あいて}}](term:term-opponent) — l'avversario, qui come player da attaccare.
- [{{攻撃|こうげき}}](term:term-attack) — attacco; l'azione che il divieto impediva.
- [{{効果|こうか}}](term:term-effect) — effetto o blocco di rules text che produce una conseguenza.
- [{{無効|むこう}}](term:term-mukou) — nullo, non valido, senza effetto operativo.
- [すべて](term:term-subete) — tutto il gruppo appena definito, senza scegliere singoli casi.
- [{{召喚|しょうかん}}{{酔|よ}}い](term:term-shoukan-yoi) — summon sickness, citata come esempio di divieto annullato.

## Espressioni ricorrenti

- このターン — cornice temporale limitata al turno attuale.
- [{{攻撃|こうげき}}](term:term-attack)することができない — non poter attaccare, in forma analitica.
- [{{無効|むこう}}](term:term-mukou)になる — diventare nullo / smettere di applicarsi.
- この[{{効果|こうか}}](term:term-effect)によって — per mezzo di questo effetto, cioè grazie alla spell appena risolta.

## Pattern grammaticali chiave

- Vることができない — nominalizza l'azione e la chiude come impossibile.
- Nは[すべて](term:term-subete) [{{無効|むこう}}](term:term-mukou)になる — tutto il gruppo N diventa non valido.
- Nによって...になる / ならない — indica il mezzo che produce, o non produce, un nuovo stato.

## Etichette da riconoscere

- ダイヤモンド・ソード — nome della spell, scritto in katakana.
- [{{相手|あいて}}](term:term-opponent)プレイヤー — il giocatore avversario come bersaglio diretto dell'attacco.
- [クリーチャー](term:term-creature) — bersaglio escluso dalla clausola finale.
...
:::example_sentence
jp: >-
  このターン、[{{自分|じぶん}}](term:term-self)のクリーチャーが[{{相手|あいて}}](term:term-opponent)プレイヤーを
  [{{攻撃|こうげき}}](term:term-attack)することができない
  [{{効果|こうか}}](term:term-effect)は[すべて](term:term-subete)
...
:::example_sentence
jp: >-
  [{{召喚|しょうかん}}{{酔|よ}}い](term:term-shoukan-yoi)や、
  「このクリーチャーは[{{攻撃|こうげき}}](term:term-attack)できない」または
  「このクリーチャーは、[{{相手|あいて}}](term:term-opponent)プレイヤーを
  [{{攻撃|こうげき}}](term:term-attack)できない」などの
  [{{効果|こうか}}](term:term-effect)が[{{無効|むこう}}](term:term-mukou)になる。
translation_it: >-
  Effetti come la summon sickness, “questa creatura non può attaccare” oppure
  “questa creatura non può attaccare il giocatore avversario” diventano nulli.
reveal_mode: sentence
:::
...
translation_it: >-
  Tuttavia, questo effetto non rende possibile attaccare le creature.
reveal_mode: sentence
:::
...
Le stesse forme diventano più leggibili quando separi gruppo, risultato e limite:

:::example_sentence
jp: >-
  このターン、[{{召喚|しょうかん}}{{酔|よ}}い](term:term-shoukan-yoi)の
  [{{効果|こうか}}](term:term-effect)は[{{無効|むこう}}](term:term-mukou)になる。
translation_it: >-
  In questo turno, l'effetto della summon sickness diventa nullo.
reveal_mode: sentence
:::

:::example_sentence
jp: >-
  「このクリーチャーは[{{攻撃|こうげき}}](term:term-attack)できない」という
  [{{効果|こうか}}](term:term-effect)も[{{無効|むこう}}](term:term-mukou)になる。
translation_it: >-
  Anche l'effetto “questa creatura non può attaccare” diventa nullo.
reveal_mode: sentence
:::

:::example_sentence
jp: >-
  [{{自分|じぶん}}](term:term-self)のクリーチャーは[{{相手|あいて}}](term:term-opponent)プレイヤーを
  [{{攻撃|こうげき}}](term:term-attack)できるが、クリーチャーを
  [{{攻撃|こうげき}}](term:term-attack)できるようにはならない。
translation_it: >-
  Le tue creature possono attaccare il giocatore avversario, ma non diventano
  automaticamente in grado di attaccare creature.
reveal_mode: sentence
:::
