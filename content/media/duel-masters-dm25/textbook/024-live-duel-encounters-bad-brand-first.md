...
- [バトルゾーン](term:term-battle-zone) — destinazione positiva della carta
  rivelata.
- [{{手札|てふだ}}](term:term-hand) — destinazione alternativa quando la carta
  viene aggiunta invece di entrare in campo.
- [{{出|だ}}す](term:term-dasu), [{{加|くわ}}える](term:term-add) e
  [{{置|お}}く](term:term-oku) — i tre movimenti del ramo: campo, mano, fondo
  del mazzo.

## Espressioni ricorrenti

- [{{山札|やまふだ}}の{{上|うえ}}から{{1枚目|いちまいめ}}](term:term-top-card-of-deck) — non una carta qualsiasi: proprio la prima carta dalla cima.
...
[{{山札|やまふだ}}の{{上|うえ}}から{{1枚目|いちまいめ}}](term:term-top-card-of-deck) isola una carta precisa dalla cima. [それが...なら](grammar:grammar-sorega-nara) controlla quella stessa carta; [{{B・A・D 2|びーえーでぃーつー}}](term:term-b-a-d-two), [スピードアタッカー](term:term-speed-attacker) e [W・ブレイカー](term:term-w-breaker) restano keyword già chiuse, non parti del ramo condizionale.
