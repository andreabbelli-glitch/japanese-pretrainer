...
- [ランクマッチ](term:term-ranked-match)
- [ルームマッチ](term:term-room-match)
...
[{{達成|たっせい}}](term:term-achievement) riguarda il completamento.
[{{報酬|ほうしゅう}}](term:term-reward) riguarda ciò che ottieni.

Dentro l'app è una coppia molto pratica:

- se una condizione è [{{達成|たっせい}}](term:term-achievement), allora qualcosa conta come
  completato;
- ma devi comunque controllare se la [{{報酬|ほうしゅう}}](term:term-reward) è già
  riscattata, ancora disponibile o già `{{済|ず}}み`.
...
- [{{解放|かいほう}}](term:term-unlock) ti dice che il problema è l'accesso, non
  la comprensione del menu.
