...
title: TCG Core - Entrare nel gioco e leggere la carta
order: 10
...
prerequisites: []
summary: >-
  Introduzione soft a Duel Masters: obiettivo della partita, anatomia della
  carta, zone, attori e ordine pratico di lettura prima di entrare nel testo
  effetto tecnico.
---
...
- orientarti tra zone, attori e verbi base;
- fare una prima passata di lettura senza bloccarti su ogni dettaglio.
...
- mandi in campo soprattutto [クリーチャー](term:term-creature);
- attacchi gli scudi e li fai [ブレイク](term:term-break);
- quando l'avversario non ha più scudi, puoi chiudere con un attacco diretto.

La parte importante per il giapponese è questa: le carte descrivono quasi
sempre movimenti, condizioni, bersagli e timing. Non stai leggendo prosa
libera. Stai leggendo istruzioni.
