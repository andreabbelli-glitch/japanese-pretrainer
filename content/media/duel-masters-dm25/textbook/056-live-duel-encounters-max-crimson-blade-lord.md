...
- [{{3000|さんぜん}}](term:term-sanzen) — tremila; la lettura sonora `さんぜん` riappare dentro `{{3000以下|さんぜんいか}}`.
...
- [ブロッカー](term:term-blocker) — la keyword che permette di bloccare; qui non appare come nome, ma resta dietro al verbo `ブロックされる`.
