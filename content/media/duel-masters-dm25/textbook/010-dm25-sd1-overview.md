...
summary: >-
  Lezione verticale sullo starter deck `DM25-SD1 技の王道`: piano di gioco,
  lessico del cimitero, nomi da fissare e modo pratico di leggere le carte
  chiave dell'asse Abyss.
---

# Obiettivo

Questa lesson prende il primo starter deck come caso reale. Il punto non è
solo sapere "che carte contiene", ma capire quale giapponese ti costringe a
leggere.
...
- perché il mazzo ruota attorno a [墓地](term:term-graveyard) e
  [アビス](term:term-abyss);
- quali nomi e parole fungono da ancora mentre scorri la lista carte;
- che differenza c'è tra leggere il piano di gioco del mazzo e leggere il suo
  testo carta.
...
- nomi propri ricorrenti che vale la pena fissare a vista.

Per questo mazzo, capire il gioco e capire il giapponese vanno davvero insieme:
se non capisci che il cimitero è una risorsa, leggi male metà delle frasi.
...
### 4. Come leggere il lessico di tribù
...
### 5. La grammatica tipica di questo mazzo
...
### 6. Perché questo deck è ottimo per il giapponese
