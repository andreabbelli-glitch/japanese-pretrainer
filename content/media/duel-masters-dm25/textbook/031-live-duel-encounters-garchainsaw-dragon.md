...
- [{{選|えら}}ぶ](term:term-erabu) — scegliere un bersaglio preciso
- [バトルさせる](term:term-battle-saseru) — far combattere due creature
- [ブレイク](term:term-break) — rompere gli scudi
...
- [W・ブレイカー](term:term-w-breaker) — keyword offensiva: la creatura rompe due scudi quando attacca un giocatore
