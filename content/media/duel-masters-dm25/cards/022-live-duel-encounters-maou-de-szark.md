...
title: Carte incontrate in partita 2 - De Szark, Gate of Moonless Night e Magic Tool
order: 51
...
meaning_it: De Szark / boss che sfrutta Gate of Moonless Night
pos: proper-noun
...
reading: すべて
romaji: subete
meaning_it: tutti / tutto l'insieme nominato
pos: noun
aliases: [すべて, subete]
notes_it: >-
  `すべて` estende l'effetto all'intero gruppo appena definito invece di
  lasciarlo su un bersaglio singolo. In
  `{{相手|あいて}}のクリーチャーすべて`, il senso corretto è `tutte le
  creature avversarie`.
level_hint: n5
:::
...
id: grammar-sorera
pattern: それら
title: Ripresa del gruppo appena nominato
reading: それら
meaning_it: quelli / quelle / quegli elementi appena menzionati
aliases: [それら]
notes_it: >-
  Nel rules text `それら` serve a riprendere un gruppo costruito subito prima.
  In `それら{{4枚|よんまい}}の{{上|うえ}}に`, non introduce nuove carte: ti
  rimanda proprio alle quattro appena scelte nella procedura.
level_hint: n4
:::
...
notes_it: >-
  ...
  del pacchetto `{{無月|むげつ}}の{{門|もん}}`: quando lo riconosci al volo,
  leggi il resto della frase con molta meno fatica.
...
notes_it: >-
  Qui `すべて` chiude il dubbio sullo scope: l'effetto prende l'intero gruppo
  `{{相手|あいて}}のクリーチャー` e non una sola creatura scelta.
tags: [live-duel, scope, quantifier, rules-text]
:::
