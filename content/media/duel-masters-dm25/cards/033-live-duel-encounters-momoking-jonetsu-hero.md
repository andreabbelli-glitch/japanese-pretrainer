...
notes_it: >-
  Qui il centro del chunk e` `{{攻撃中|こうげきちゅう}}に`. `{{中|ちゅう}}`
...
card_type: concept
front: 'その{{攻撃中|こうげきちゅう}}にシールドをブレイクしていれば'
back: Se durante quell'attacco ha rotto uno scudo.
example_jp: >-
  その[クリーチャー](term:term-creature)がその{{攻撃中|こうげきちゅう}}に
...
notes_it: >-
  `その{{攻撃中|こうげきちゅう}}に` chiude la condizione dentro lo stesso
