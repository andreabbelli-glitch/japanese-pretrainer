...
difficulty: n4
status: active
tags: [random, videogame, dragon-quest-smash-grow, auto-mode, tutorial, dialogue]
prerequisites: []
summary: >-
  Leggi il tutorial della modalità auto e una battuta narrativa sulla nascita
...
alt: >-
  Dialogo di Dragon Quest Smash Grow in cui il robottino annuncia una nuova
  leggenda.
caption: >-
  `{{生|う}}まれようとしてイル` usa
