...
function buildReviewCard(
  ...
  return {
    ...
    exampleAudioSrc: input.exampleAudioSrc ?? null,
    exampleAudioSource: input.exampleAudioSource ?? null,
    exampleAudioSpeaker: input.exampleAudioSpeaker ?? null,
    exampleAudioLicense: input.exampleAudioLicense ?? null,
    exampleAudioAttribution: input.exampleAudioAttribution ?? null,
    exampleAudioPageUrl: input.exampleAudioPageUrl ?? null,
