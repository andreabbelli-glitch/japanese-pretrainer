ALTER TABLE `review_log` ADD `scheduler_version` text DEFAULT 'fsrs_v1' NOT NULL;--> statement-breakpoint
...
ALTER TABLE `review_state` ADD `scheduler_version` text DEFAULT 'fsrs_v1' NOT NULL;
