...
**Regola d'oro: se modifichi il codice parser, il database o la struttura
prevista per i markdown, devi obbligatoriamente aggiornare la documentazione e i
template in `docs/llm-kit/general/`.**
