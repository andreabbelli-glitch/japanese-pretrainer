...
- Per `example_jp`, riusa una frase reale della carta o della schermata solo se
  la entry compare li come unita naturale e la frase intera resta leggibile;
  altrimenti scrivi una parafrasi breve ma fedele al contesto Duel Masters.
- Se la entry e stata estratta da una locuzione piu lunga e da sola non
  ...
  dominio Duel Masters che la usi bene.
