...
Le riscritture sono esempi concreti di soluzione. Quando una frase è una citazione autentica, va prima ricostruita con i suoi parlanti e il contesto; non va normalizzata come se fosse un esempio inventato.

## Migaku Grammar — 8 voci

### JA-001 · P1 · より: confronto descritto come meno favorito

**Corretto** · certezza: alta · [054-yori-comparisons.md:22](</Users/abelli/Codex/Japanese Custom Study/content/media/migaku-grammar/cards/054-yori-comparisons.md:22>)

Riferimento stabile: `card-054-yori-comparisons-concept`.

**Fronte → retro:** より → A より significa «rispetto ad A / più che A» e marca il termine meno favorito o di grado inferiore.

**Esempio:** この店はあの店より安い。

**Traduzione:** Questo negozio è più economico di quello.
...
**Attuale:** Si aggiunge a una forma piana; con Nome／Aな al presente compare だ prima di もの: 静かなものだ è attributivo, 静かだものだ appartiene ad altri usi e va valutato nel contesto. V passato + ものだ richiama spesso abitudini nostalgiche; V non-passato + ものだ può enunciare una norma. Nel parlato emotivo もの si contrae in もん.
...
**Corretto** · certezza: alta · [197-suru-5-indicate-cost.md:22](</Users/abelli/Codex/Japanese Custom Study/content/media/migaku-grammar/cards/197-suru-5-indicate-cost.md:22>)

Riferimento stabile: `card-197-suru-5-indicate-cost-concept`.

**Fronte → retro:** する → Quantità di denaro o tempo + する indica quanto qualcosa costa o dura.

**Esempio:** このバッグは五千円する。

**Traduzione:** Questa borsa costa cinquemila yen.
...
**Attuale:** Si combina spesso con Vてください, Vてほしい, たい o inviti. È orientato a desideri e azioni volontarie; non è normale con semplici dichiarazioni d'intenzione del parlante, desideri negativi o fenomeni non controllabili. La grafia 是非 esiste, ma il kana è comune.
...
**Corretto** · certezza: alta · [381-being-more-polite-with-receptive-form.md:23](</Users/abelli/Codex/Japanese Custom Study/content/media/migaku-grammar/cards/381-being-more-polite-with-receptive-form.md:23>)

Riferimento stabile: `card-381-being-more-polite-with-receptive-form-concept`.

**Fronte → retro:** 受け身 → Trasformare il verbo in れる／られる può elevare l'azione di una persona rispettata mantenendo le particelle della frase attiva.

**Esempio:** 先生は何時に来られますか。

**Traduzione:** A che ora arriverà il professore?
...
**Corretto** · certezza: alta · [310-self-moving-and-other-moving-verbs.md:23](</Users/abelli/Codex/Japanese Custom Study/content/media/migaku-grammar/cards/310-self-moving-and-other-moving-verbs.md:23>)

Riferimento stabile: `card-310-self-moving-and-other-moving-verbs-concept`.

**Fronte → retro:** 自動詞・他動詞 → Distinzione tra verbi che agiscono su un oggetto e verbi di cambiamento autonomo

**Esempio:** 私が窓を開けると、風でドアが開いた。

**Traduzione:** Quando ho aperto la finestra, la porta si è aperta per il vento.
...
**Corretto** · certezza: alta · [375-youto-attempt-do-something.md:23](</Users/abelli/Codex/Japanese Custom Study/content/media/migaku-grammar/cards/375-youto-attempt-do-something.md:23>)

Riferimento stabile: `card-375-youto-attempt-do-something-concept`.

**Fronte → retro:** ようと → Forma volitiva + と + verbo d'azione presenta un gesto compiuto nel tentativo di raggiungere l'obiettivo.

**Esempio:** ドアを開けようとしたが、鍵がかかっていた。

**Traduzione:** Ho provato ad aprire la porta, ma era chiusa a chiave.
...
**Fronte → retro:** 相手プレイヤーを攻撃できない。相手の クリーチャーが攻撃する時、かわりにこの クリーチャーをタップしてもよい。 → Non può attaccare il giocatore avversario; quando una creatura avversaria attacca, puoi invece tappare questa creatura per bloccare.

**Esempio:** ブロッカーを持つクリーチャーは、 相手プレイヤーを直接攻撃できない。

**Traduzione:** Una creatura con Blocker non può attaccare direttamente il giocatore avversario.

**Proposta e motivo:** Separare Blocker dal divieto di attaccare il giocatore. Blocker permette di tappare e cambiare il bersaglio; non impone da solo il divieto.
...
**Fronte → retro:** 進化元にも進化先にもなれるように扱って、 進化のつながりを作る。 → La tratta in modo che possa funzionare sia come base sia come estensione di un'evoluzione, creando il collegamento evolutivo.

**Esempio:** このタマシードを進化元にも進化先にもなれるように 扱う。

**Traduzione:** Tratta questo Tamaseed in modo che possa funzionare sia come base sia come estensione di un'evoluzione.

**Proposta e motivo:** Il Tamaseed può essere base di evoluzione; non diventa anche destinazione di evoluzione.
...
**Fronte → retro:** アビスラッシュ → Abyss Rush

**Esempio:** アビスラッシュ：このクリーチャーが離れる時、かわりに 自分の手札を2枚捨ててもよい。

**Traduzione:** Abyss Rush: quando questa creatura sta per lasciare il campo, puoi invece scartare 2 carte dalla tua mano.

**Proposta e motivo:** Sostituire l’effetto di scarto di due carte con evocazione dal cimitero, attacco al giocatore nel turno e collocazione in fondo al mazzo a fine turno. Confrontare Jashin DM25SD1-002.
...
**Fronte → retro:** シビルカウント → Civil Count

**Esempio:** シビルカウント3：自分の闇のカードのコストの 合計が3以上であれば、このクリーチャーの 「S・トリガー」を使ってもよい。

**Traduzione:** Civil Count 3: se la somma dei costi delle tue carte oscurità è 3 o più, puoi usare l'S-Trigger di questa creatura.

**Proposta e motivo:** Si contano creature e Tamaseed della civiltà nella zona di battaglia, non la somma dei costi. Correggere anche la pagina 010 che insegna esplicitamente la regola opposta.
...
**Fronte → retro:** 好きな順序で → nell'ordine che preferisci

**Esempio:** 残りを好きな順序で山札の下に置く。

**Traduzione:** Metti il resto in fondo al mazzo nell'ordine che preferisci.
...
**Fronte → retro:** 1つずつ → uno a uno / uno per volta

**Esempio:** 他の各相手のシールドも 1つずつブレイクする。

**Traduzione:** Rompe anche uno scudo di ciascun altro avversario.
...
**Traduzione:** Finché non completi i requisiti, questo stage evento resterà non ancora sbloccato.
...
**Traduzione:** Abyss Rush: invece di lasciare il battle zone, puoi riprendere in mano dal cimitero una creatura con Abyss Rush.

**Proposta e motivo:** Sostituire la definizione e l’esempio con la vera abilità アビスラッシュ, dopo confronto ufficiale; riprendere una creatura dal cimitero non ne è l’effetto. Correggere anche la definizione che parla di scartare 2 carte.
...
**Traduzione:** Shinkarize: tratta la carta in modo da poter fare da base o da estensione di un'evoluzione e creare il collegamento evolutivo.

**Proposta e motivo:** Descrivere la possibilità di mettere una creatura evoluzione sopra il Tamaseed come se quest’ultimo fosse una creatura. Eliminare l’idea che il Tamaseed diventi anche destinazione evolutiva.
...
**Traduzione:** Quando questa creatura entra, scegli una delle seguenti opzioni.
...
**Traduzione:** Yukime, Karma della raffica, distrugge una creatura dell'avversario quando quella creatura entra con un metodo diverso dall'evocazione.
...
**Fronte → retro:** かわりに → invece di; al posto di; in cambio

**Esempio:** カードを1枚 引く。かわりに、手札を1枚 捨てる。

**Traduzione:** Pesca 1 carta; in cambio, scarta 1 carta dalla mano.
...
**Fronte → retro:** 交換期間 → periodo di scambio / exchange period

**Esempio:** カードの交換期間が終了時に近づいている。

**Traduzione:** Il periodo di scambio della carta si sta avvicinando al termine.
...
**Fronte → retro:** それら4枚の上に → sopra quelle quattro carte appena nominate

**Esempio:** それら4枚の上に重なるから、 さっき選んだ素材を見失わない。

**Traduzione:** Siccome si sovrappone sopra quelle quattro carte, non devi perdere di vista i materiali che hai appena scelto.
...
**Fronte → retro:** 相手の人数と同じ枚数 → il numero di carte pari al numero di avversari

**Esempio:** 相手のクリーチャーと同じ枚数のカードを、墓地から選ぶ。

**Traduzione:** Scegli dal cimitero un numero di carte pari al numero delle creature avversarie.
...
**Fronte → retro:** エターナル・Ω → ritorna in mano invece di lasciare il campo

**Esempio:** 「エターナル・Ω」を持つクリーチャーが離れる時、 かわりに手札に戻す。

**Traduzione:** Quando una creatura con Eternal Omega dovrebbe lasciare il campo, torna in mano invece.
...
**Fronte → retro:** このゲームが2人以上の相手がいる 状態で始まっていて → se la partita è iniziata con due o più avversari presenti

**Esempio:** このゲームが2人以上の相手がいる 状態で始まっていて、S・トリガーを使える。

**Traduzione:** La partita è iniziata con due o più avversari, quindi puoi usare S-Trigger.
...
**Traduzione:** Poiché possiedi solo 2 copie della carta rara, puoi inserirne altre 2 nel deck.

**Proposta e motivo:** La frase passa da 2 copie possedute ad altre 2 inseribili senza dire quante sono già nel mazzo. Per spiegare il limite di quattro: このカードはデッキに2枚入っているので、あと2枚入れられる。 «Nel mazzo ci sono 2 copie di questa carta, quindi posso aggiungerne altre 2».
...
**Voce:** 可能形 → potere fare... / essere in grado di fare...

**Nota:** La forma potenziale dice che un'azione è possibile o che qualcuno è capace di farla: “posso andare”, “riesco a mangiare”, “si può entrare”. Con molti verbi in -u la vocale cambia in -eる: 行く → 行ける, 戦う → 戦える. Con i verbi in -る: 食べる → 食べられる. Eccezioni importanti: する → できる, 来る → 来られる. Nei testi di gioco questa forma segnala molto spesso cosa puoi fare adesso e cosa invece non è ancora disponibile.
...
**Fronte → retro:** 以上 → più di / oltre

**Esempio:** これ以上は むりです。

**Traduzione:** Più di così è impossibile.
...
**Fronte → retro:** 謎 → mistero

**Esempio:** 学校で 謎が あります。

**Traduzione:** A scuola c'è un mistero.
...
**Fronte → retro:** finali di frase よ / ね / な → enfasi / conferma / tono emotivo

**Esempio:** ようやくだよ。 / ようやくだね。 / ようやくだな。

**Traduzione:** Finalmente! / Finalmente, vero? / Finalmente, eh.
...
**Attuale:** 二つ名パワー — reading: につなパワー

**Proposta e motivo:** Correggere reading e ogni furigana a ふたつなパワー; verificare gli asset di pronuncia associati alla voce dopo la modifica.
...
**Fronte → retro:** 順位 → posizione in classifica

**Esempio:** 順位は 三 です。

**Traduzione:** La posizione in classifica è 3.
...
**Fronte → retro:** 落下 → caduta

**Esempio:** この先に 落下が あります。

**Traduzione:** Più avanti c'è rischio di caduta.
...
**Fronte → retro:** 分類 → categoria / classificazione

**Esempio:** 技には 物理と 特殊の ふたつの 分類が 存在する。

**Traduzione:** Le mosse sono classificate in due categorie: fisiche e speciali.
...
**Fronte → retro:** 小生 → しょうせい — io (umile/letterario); pronome di prima persona antiquato, usato solo da uomini per abbassarsi rispetto a chi ascolta.

**Esempio:** 小生はアカデミーで美術を教えております。

**Traduzione:** Il sottoscritto insegna arte all'Accademia.

**Proposta e motivo:** Conservare la voce caratteristica di Hassaku. Correggere la spiegazione: pronome tradizionalmente maschile ed epistolare, umile nella forma, usato tipicamente verso pari o inferiori. Rimuovere «esclusivamente uomini colti» e non proporlo come formula universalmente deferente.
...
**Fronte → retro:** 団員 → だんいん — membro del gruppo/team (es.

**Esempio:** あの テントの 前に スター団の 団員が いる。

**Traduzione:** Ci sono dei membri del Team Star davanti a quella tenda.
...
**Fronte → retro:** 楽しみにする → たのしみにする — attendere con ansia.

**Esempio:** 課外授業を通して大きく成長したあなたたちに再びご挨拶できることを楽しみにしておりますよそれでは宝探し開始！

**Traduzione:** Non vedo l’ora di salutarvi di nuovo, voi che siete cresciuti tantissimo grazie alle lezioni extra. Allora, che la caccia al tesoro abbia inizio!
...
**Fronte → retro:** 一応 → いちおう — per sicurezza; comunque; per il momento.

**Esempio:** ...ああ一応言っておくがパルデアの大穴およびエリアゼロは関係者以外立ち入り禁止だ宝探しだウッヒョー！

**Traduzione:** …Ah, te lo dico per sicurezza: il Grande Voragine di Paldea e l’Area Zero sono vietati a chi non è autorizzato. Caccia al tesoro, evviva!
...
**Fronte → retro:** うちら → うちら — noi, in registro colloquiale.

**Esempio:** すまんなうちらの大将たまにこうなってしまうんやだだっでぇ！

**Traduzione:** Scusa, il nostro capo ogni tanto fa così, è proprio così!
...
**Fronte → retro:** ころがす → ころがす — far rotolare; rovesciare; far girare.

**Esempio:** オリーブと間違えてミニーブをころがさないようにね！

**Traduzione:** Attenti a non scambiare Smoliv per Olive e a non farlo rotolare via!
...
**Fronte → retro:** さらなる → さらなる — ancora di più; ulteriormente.

**Esempio:** ではさんに問おうさらなる食事パワーを得るためにはきみは何に気をつけるのだ？

**Traduzione:** Allora, ti chiedo: per ottenere ancora più potere dal cibo, a cosa devi prestare attenzione?
...
**Fronte → retro:** まいる → まいる — andare o venire, in registro umile; essere sopraffatto.

**Esempio:** じゃあ即刻消えなさいわたしここを離れないからまいります！

**Traduzione:** Allora sparisci subito. Io non lascerò questo posto: mi faccio avanti!
...
**Fronte → retro:** いたす → いたす — fare, forma umile di する.

**Esempio:** 大変失礼いたしましたこのおかたはどちらさまなのでしょう？

**Traduzione:** Chiedo mille scuse, chi sei tu?
...
**Fronte → retro:** 傷つく → きずつく — essere ferito; subire un infortunio; ferire i sentimenti di qualcuno.

**Esempio:** ...黙りなさいわたしはわたし以外誰も傷ついてほしくないだけよ優しいボスさん勝負再開といこうか！

**Traduzione:** …Stai zitto, voglio solo che nessuno, a parte me, si faccia male. Capo gentile, riprendiamo la sfida!
...
**Fronte → retro:** しまう → しまう — mettere via; finire; completare anche con sfumatura involontaria.

**Esempio:** 大事な道具をバッグにしまう。

**Traduzione:** Ripongo nella Borsa lo strumento appena ottenuto.
...
**Fronte → retro:** 理事長 → りじちょう — presidente del consiglio di amministrazione; amministratore delegato; direttore generale.

**Esempio:** いやいやこの人たしか学校の理事長でもあるしマジ？

**Traduzione:** No, no, questa persona è anche il presidente del consiglio scolastico, sul serio?
...
**Fronte → retro:** ってか → ってか — o piuttosto (dire); o meglio (dire); o forse dovrei dire.

**Esempio:** えーでもエリアゼロ来てからライドするんも嫌がってるしってかバトルフォルムになれんのでしょ？

**Traduzione:** Ehm, ma da quando sei arrivato nell’Area Zero non vuoi più fare i Ride, e poi non riesci a trasformarti in Battle Form, giusto?
...
**Fronte → retro:** 再会 → さいかい — ritrovo; ricongiungimento.

**Esempio:** 宝探し中再会したらとも戦わせてよね！

**Traduzione:** Se ci ritroviamo durante la caccia al tesoro, fammi combattere anche contro di te!
...
**Fronte → retro:** 寮 → りょう — dormitorio; collegio.

**Esempio:** ジニア先生から寮の部屋を案内するように言われたの！

**Traduzione:** Il professor Zinia mi ha chiesto di farti vedere la mia stanza nel dormitorio!
...
**Fronte → retro:** すみか → すみか — tana; habitat; dimora.

**Esempio:** ドラゴンタイプのヌシのすみか！

**Traduzione:** La tana del signore dei draghi!
...
**Fronte → retro:** 完成 → かんせい — completamento; perfezione; realizzazione.

**Esempio:** わたしの質問に図鑑の完成を目指すって言ってくれたよね！

**Traduzione:** Hai detto che avresti completato la guida per rispondere alla mia domanda, vero?
...
**Fronte → retro:** 呼びだす → よびだす — chiamare (qualcuno) alla (porta, al telefono, ecc.); dire a (qualcuno) di venire; chiamare (al telefono).

**Esempio:** ああいじめっ子をまとめてグラウンドに呼びだしたってさいよいよか！

**Traduzione:** Ah, hai finalmente radunato tutti i bulli sul campo, eh?!
...
**Fronte → retro:** 実りある → みのりある — gratificante; fruttuoso; fertile.

**Esempio:** それじゃあよろしく実りある勝負にしよっ！

**Traduzione:** Allora, ci vediamo! Facciamo in modo che sia una sfida fruttuosa!
...
**Fronte → retro:** ヤダ → ヤダ — nemmeno per sogno; improbabile; assolutamente no.

**Esempio:** ヤダ！そんな危ない場所には行きたくない。

**Traduzione:** No! Non voglio andare in un posto così pericoloso.
...
**Traduzione:** Quindi, questo vuol dire che ci contatterai di nuovo?
...
**Fronte → retro:** 捕まえる → catturare

**Esempio:** HPを 減らしてから 捕まえると 成功しやすい。

**Traduzione:** Se lo catturi dopo avergli abbassato gli HP, riesci più facilmente.
...
**Fronte → retro:** ～ないで → senza fare / non fare e...

**Esempio:** ここで バトルしないで。

**Traduzione:** Non combattere qui.
...
**Fronte → retro:** ～前に → prima di fare... / prima di...

**Esempio:** 行く 前に、 大丈夫ですか。

**Traduzione:** Prima di andare, va bene?
...
**Fronte → retro:** いってらっしゃい → buon viaggio / vai e torna

**Esempio:** いってらっしゃい。

**Traduzione:** Vai e torna.
...
**Fronte → retro:** がけのぼり → arrampicata sulla parete

**Esempio:** この先に がけのぼりが あります。

**Traduzione:** Più avanti c'è l'arrampicata sulla parete.
...
**Fronte → retro:** 自分だけ → solo per sé

**Esempio:** 自分だけ 先に 行く。

**Traduzione:** Solo io vado avanti.
...
**Fronte → retro:** 本校 → sede principale

**Esempio:** 本校へ 行きます。

**Traduzione:** Vado alla sede principale.
...
**Fronte → retro:** 物理 → fisico / Physical

**Esempio:** 物理は ポケモンの 攻撃が 高ければ 相手に 与える ダメージが 大きい。

**Traduzione:** Le mosse fisiche fanno più danni se il Pokémon ha un Attacco alto.
...
**Fronte → retro:** 貴方 → あなた — tu (forma scritta/formale); pronome di seconda persona distaccato, usato in assenza di confidenza o in testi scritti formali.

**Esempio:** 貴方のポケモン、とても強そうですね。

**Traduzione:** Il tuo Pokémon sembra davvero forte.
...
**Voce:** ～ば ～ほど → più succede X, più aumenta Y

**Nota:** Collega due movimenti che crescono insieme. In questo arco è perfetto per leggere osservazioni come `見れば 見るほど`: più Pepper osserva il Pokémon misterioso, più lo trova strano o degno di attenzione.
...
**Fronte → retro:** 襲いかかる → おそいかかる — attaccare; avventarsi su; piombare su.

**Esempio:** 一見ドンファンに似たその生物は突如球体に変化すると高速で回転し襲いかかってきたという。

**Traduzione:** A prima vista, quella creatura simile a Donphan si trasformò all'improvviso in una sfera, ruotò ad alta velocità e si lanciò all'attacco.
...
**Fronte → retro:** それでも → それでも — ma (comunque); eppure; ciononostante.

**Esempio:** それでもダメならおうえんだ！

**Traduzione:** Se proprio non ce la fai, ti faccio il tifo!
...
**Fronte → retro:** 差し上げる → さしあげる — dare; offrire con umiltà.

**Esempio:** ゆえにLPを差し上げようぞお疲れさまでスターでござる！

**Traduzione:** Quindi ti darò un po’ di LP. Grazie per il tuo impegno, sei una vera stella!
...
**Traduzione:** Le statistiche del Pokémon cresciuto sono al massimo!
...
**Traduzione:** Nemi sceglie avversari molto più forti del tipo Coleottero, vero?
...
**Traduzione:** Proviamo a cercare Pokémon shiny usando il tipo di pasto legato all'Elettro.
...
**Traduzione:** Nel menu è stata aggiunta una nuova funzione.
...
**Traduzione:** La mossa di tipo Terra sembra avere un hit rate basso, quindi controlliamo prima le impostazioni.
...
**Traduzione:** Se compri tutto insieme, forse la ricarica diventerà più veloce.
...
**Traduzione:** Attendi un momento. Gli ingredienti del panino sono già registrati nell'app fotocamera.
...
**Traduzione:** Attivo il salvataggio automatico e aggiungo alle scorciatoie una mossa che uso spesso.
...
**Traduzione:** Quando scegli il ritiro del regalo, lo strumento viene aggiunto alla borsa.
...
**Traduzione:** Bentornato. Sono tornato.
...
**Traduzione:** Se combattiamo insieme, ho il presentimento che riusciremo a scacciare un avversario difficile.
...
**Traduzione:** Quando vieni chiamato con il numero di matricola, l'atmosfera diventa quella del linguaggio cortese da aula.
...
**Traduzione:** Che ne dici di una sedicente divinazione via smartphone?
...
**Traduzione:** Parlo un po' con Nemi dei Pokémon.
...
**Traduzione:** Se usi questa macchina, la quantità di dati aumenta.
...
**Traduzione:** Benvenuto. Facciamoci curare la squadra al Pokémon Center.
...
**Traduzione:** Quando una scena ti convoca nell'ufficio del preside, di solito parte un briefing ufficiale o una decisione della storia.

**Proposta e motivo:** Tradurre «Quando vieni convocato nell’ufficio del preside, spesso c’è qualcosa di importante da discutere». Spostare la spiegazione sul funzionamento del gioco nelle note.
...
**Fronte → retro:** 何度も → なんども — molte volte; ripetutamente

**Esempio:** カルを何度も救う。

**Traduzione:** Ho salvato Kal molte volte.
...
**Voce:** Nではありません → non e' N; non era N

**Nota:** ではありません e' la versione cortese di じゃない. Al passato diventa ではありませんでした.
...
**Fronte → retro:** 気に入る → きにいる — piacere; andare a genio

**Esempio:** 弓が気に入る。

**Traduzione:** L'arco mi piace.
...
**Fronte → retro:** 子 → こ — bambino; persona giovane

**Esempio:** 火事の建物に子がいる。

**Traduzione:** C'è un bambino nell'edificio in fiamme.
...
**Fronte → retro:** 手を出す → てをだす — mettere le mani addosso; fare una mossa contro

**Esempio:** 家族に手を出すな。

**Traduzione:** Non mettere mano sulla mia famiglia.
...
**Fronte → retro:** 一体 → いったい — mai; in assoluto

**Esempio:** 一体何者だ？

**Traduzione:** Chi diavolo sei?
...
**Fronte → retro:** Nではありません → non è N, in forma cortese

**Esempio:** これはたくさんのお金ではありません。

**Traduzione:** Questo non è molto denaro.
...
**Fronte → retro:** 奴 → やつ — tipo; tizio; cosa

**Esempio:** あの奴は強い。

**Traduzione:** Quel tipo è forte.
...
**Fronte → retro:** 二度 → にど — due volte; una seconda volta

**Esempio:** 二度とそんな事はしない。

**Traduzione:** Non farò mai più una cosa del genere.
...
**Fronte → retro:** 外す → はずす — togliere; rimuovere

**Esempio:** 帽子を外す。

**Traduzione:** Tolgo il cappello.
...
**Fronte → retro:** 物 → もの - cosa fisica; oggetto

**Esempio:** この物に触れるな。

**Traduzione:** Non toccare questo oggetto.
...
**Fronte → retro:** XはYは...だと言う → X dice che Y...

**Esempio:** 女王は「お前達はバカだ」と言った。

**Traduzione:** La regina ha detto che siamo stupidi.
...
**Traduzione:** Oggi offro io. Accetto volentieri l'offerta.
...
**Traduzione:** No. Voglio riprendere conoscenza.
...
**Traduzione:** L'uomo si avventa contro Naitsu!

**Proposta e motivo:** Uniformare la traduzione del personaggio al nome già usato nel media, Knites; evitare Naitsu nella sola frase.
...
**Fronte → retro:** 言い訳 → apology, excuse

**Esempio:** あなたは言い訳が多すぎます。

**Traduzione:** You give too many excuses.
...
**Fronte → retro:** 情けない → pathetic, shameful

**Esempio:** こんなことも知らないとは情けない。

**Traduzione:** It's pathetic that you don't also know this.
...
**Fronte → retro:** 問う → to ask, to inquire

**Esempio:** 応募者の年齢は問いません。

**Traduzione:** We will not inquire about the age of the applicants.
...
**Fronte → retro:** 偉い → great, famous

**Esempio:** 彼は偉い学者です。

**Traduzione:** He's a famous scholar.
...
**Fronte → retro:** 最も → the most

**Esempio:** 彼は世界で最も早い男です。

**Traduzione:** He's the fastest man in the world.
...
**Fronte → retro:** 神様 → God, the divine

**Esempio:** 神様にお願いしました。

**Traduzione:** I asked a favor to God.
...
**Fronte → retro:** 衝撃 → impact, shock

**Esempio:** 衝撃のニュースが飛び込んできた。

**Traduzione:** The shocking news filled the airwaves.
...
**Fronte → retro:** 熱 → fever

**Esempio:** 昨日から熱があります。

**Traduzione:** I have a fever since yesterday.
...
**Fronte → retro:** 石 → stone, small rock

**Esempio:** 私は石につまづいた。

**Traduzione:** I tripped on a stone.
...
**Fronte → retro:** 派手 → showy, flashy

**Esempio:** 雪道で派手に転んでしまったの。

**Traduzione:** I slipped spectacularly at the snowy road.
...
**Fronte → retro:** ぶつける → to bump

**Esempio:** 車を壁にぶつけてしまいました。

**Traduzione:** I hit my car into the wall.
...
**Fronte → retro:** 見守る → to watch, to keep watch over

**Esempio:** 皆で暖かく見守りましょう。

**Traduzione:** Let's all warmly watch over them.
...
**Esempio:** 今晩は月が明るく見えます。

**Traduzione:** You can see the moon brightly tonight.
...
**Fronte → retro:** 満ちる → to fill, to become full

**Esempio:** 月が満ちてきましたね。

**Traduzione:** The moon has become full, hasn't it?
...
**Traduzione:** The neck of giraffes are long.

**Proposta e motivo:** Giraffes have long necks.
...
**Fronte → retro:** 編成 → composizione; schieramento; configurazione

**Esempio:** ボスの攻撃を耐えるために、回復役を後衛に置くパーティー編成にする。

**Traduzione:** Per sopravvivere agli attacchi del boss, costruisco un team con l'healer nelle retrovie.

**Proposta e motivo:** ボスの攻撃に耐えるために…
...
**Fronte → retro:** 初心者 → principiante; beginner

**Esempio:** この記事はガチャの仕組みが初心者でもわかるように、ていねいに解説されている。

**Traduzione:** Questo articolo spiega con cura il funzionamento del gacha, così anche i principianti possono capirlo.
...
**Fronte → retro:** 防衛戦 → battaglia di difesa

**Esempio:** 押し寄せる敵から拠点にダメージが入らないように、防衛戦でしっかり陣地を守る。

**Traduzione:** In una battaglia difensiva proteggo bene la base, così i nemici che avanzano non le infliggono danni.
...
**Fronte → retro:** 考え方 → modo di pensare; approccio

**Esempio:** 難しいイベントをクリアできない時は、パーティーの考え方をガラッとかえる。

**Traduzione:** Quando non riesco a completare un evento difficile, cambio radicalmente l'approccio al party.
...
**Fronte → retro:** 使い道 → uso; impiego; use case

**Esempio:** このサポートキャラは、高難易度クエストでの使い道がとても広い。

**Traduzione:** Questo personaggio di supporto ha molti impieghi nelle missioni ad alta difficoltà.
...
**Fronte → retro:** 新規 → nuovo; da zero

**Esempio:** 新規プレイヤーは、まず無料で配られるデッキを作成するのがおすすめだ。

**Traduzione:** Ai nuovi giocatori si consiglia, come prima cosa, di creare il mazzo dato gratuitamente.
...
**Fronte → retro:** 直前 → appena prima; immediatamente prima

**Esempio:** ゲートの直前で、すこしとまった。

**Traduzione:** Ci siamo fermati un attimo proprio prima del gate.
...
**Traduzione:** Evviva! Gli HP si sono recuperati!
...
**Traduzione:** Poiché puoi ritirare quante volte vuoi, puoi aspettare finché non esce l'arma che ti piace.

**Proposta e motivo:** «Puoi ripetere l’estrazione quante volte vuoi e aspettare che esca l’arma che ti piace». Per un reroll usare «ripetere l’estrazione», non «ritirare», che suggerisce raccogliere un premio.
...
**Fronte → retro:** ランクマッチ → modalità classificata online

**Esempio:** ランクマッチでは勝敗だけでなく、次のランクポイントまで意識して潜ります。

**Traduzione:** In Rank Match tengo d'occhio non solo il risultato, ma anche i punti necessari per il grado successivo.
...
**Fronte → retro:** マイティーストライクフリーダムガンダム → Mighty Strike Freedom Gundam

**Esempio:** 高コストなので、マイティーストライクフリーダムガンダムは終盤の押し込みまで温存しやすいです。

**Traduzione:** Siccome costa molto, è facile tenere in serbo il Mighty Strike Freedom Gundam fino alla spinta finale della partita.

**Proposta e motivo:** マイティーストライクフリーダムガンダムはコストが高いので、終盤まで温存します。 «Dato il costo elevato, lo tengo in serbo fino alla fase finale». Presentare una scelta del giocatore evita l’affermazione poco motivata «è facile tenerlo in serbo».
...
**Proposta e motivo:** Uniformare «la unità / della unità» in «l’unità / dell’unità». Per 発揮, nel contesto di abilità che producono un effetto, preferire una resa concreta come «attivazione / effetto prodotto» secondo la frase, evitando di memorizzare soltanto «manifestazione».
...
**Esempio:** レビューとレヴューは意味が同じでも印象が違います。

**Proposta e motivo:** レヴューの舞台を見に、劇場へ行きました。 «Sono andato a teatro a vedere uno spettacolo di rivista». レビュー può riferirsi a una recensione, mentre レヴュー è usato anche per lo spettacolo: non presentarli come sinonimi universali.
...
**Esempio:** ディーとジーを混ぜると、読み始めで止まります。
...
**Esempio:** ファイルとハイルのような疑似語を高速で区別します。
...
**Esempio:** ウェブとエブを並べると、小さいェへの注意が上がります。
...
**Esempio:** テューバとチューブは似ていますが、表記の狙いが違います。
